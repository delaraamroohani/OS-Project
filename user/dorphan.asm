...
main(int argc, char **argv)
{
  ...
  10:	94450513          	addi	a0,a0,-1724 # 950 <malloc+0x106>
  14:	372000ef          	jal	386 <mkdir>
  18:	c919                	beqz	a0,2e <main+0x2e>
    printf("%s: mkdir dd failed\n", s);
  1a:	85a6                	mv	a1,s1
  1c:	00001517          	auipc	a0,0x1
  20:	93c50513          	addi	a0,a0,-1732 # 958 <malloc+0x10e>
  ...
  32:	92250513          	addi	a0,a0,-1758 # 950 <malloc+0x106>
  36:	358000ef          	jal	38e <chdir>
  3a:	c919                	beqz	a0,50 <main+0x50>
    printf("%s: chdir dd failed\n", s);
  3c:	85a6                	mv	a1,s1
  3e:	00001517          	auipc	a0,0x1
  42:	93250513          	addi	a0,a0,-1742 # 970 <malloc+0x126>
  ...
  54:	93850513          	addi	a0,a0,-1736 # 988 <malloc+0x13e>
  ...
  64:	94850513          	addi	a0,a0,-1720 # 9a8 <malloc+0x15e>
  ...
  7c:	91850513          	addi	a0,a0,-1768 # 990 <malloc+0x146>
  80:	716000ef          	jal	796 <printf>
    exit(1);
  84:	4505                	li	a0,1
...
00000000000003e6 <set_pid_namespace>:
...
00000000000003ee <get_pid_namespace>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 43a:	0805c363          	bltz	a1,4c0 <printint+0x94>
  neg = 0;
 43e:	4881                	li	a7,0
 ...
 44a:	58a50513          	addi	a0,a0,1418 # 9d0 <digits>
 44e:	883e                	mv	a6,a5
 ...
 468:	fec773e3          	bgeu	a4,a2,44e <printint+0x22>
  if(neg)
 46c:	00088b63          	beqz	a7,482 <printint+0x56>
    buf[i++] = '-';
 ...
 47e:	0028079b          	addiw	a5,a6,2
  ...
  while(--i >= 0)
 482:	02f05a63          	blez	a5,4b6 <printint+0x8a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ca:	855a                	mv	a0,s6
 6cc:	d43ff0ef          	jal	40e <putc>
  putc(fd, 'x');
 6d0:	07800593          	li	a1,120
 6d4:	855a                	mv	a0,s6
 6d6:	d39ff0ef          	jal	40e <putc>
 6da:	4941                	li	s2,16
