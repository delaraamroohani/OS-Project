...
00000000000001c4 <main>:
{
 ...
 226:	8fe58593          	addi	a1,a1,-1794 # b20 <malloc+0x106>
 22a:	4509                	li	a0,2
 22c:	710000ef          	jal	93c <fprintf>
    exit(1);
 230:	4505                	li	a0,1
 ...
 24c:	8f850513          	addi	a0,a0,-1800 # b40 <malloc+0x126>
 250:	716000ef          	jal	966 <printf>
      exit(1);
 254:	4505                	li	a0,1
...
00000000000005b6 <set_pid_namespace>:
...
00000000000005be <get_pid_namespace>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 60a:	0805c363          	bltz	a1,690 <printint+0x94>
  neg = 0;
 60e:	4881                	li	a7,0
 ...
 61a:	54a50513          	addi	a0,a0,1354 # b60 <digits>
 61e:	883e                	mv	a6,a5
 ...
 638:	fec773e3          	bgeu	a4,a2,61e <printint+0x22>
  if(neg)
 63c:	00088b63          	beqz	a7,652 <printint+0x56>
    buf[i++] = '-';
 ...
 64e:	0028079b          	addiw	a5,a6,2
  ...
  while(--i >= 0)
 652:	02f05a63          	blez	a5,686 <printint+0x8a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a6:	28090663          	beqz	s2,932 <vprintf+0x29a>
 ...
 6d2:	a005                	j	6f2 <vprintf+0x5a>
        putc(fd, c0);
 6d4:	85ca                	mv	a1,s2
 6d6:	855a                	mv	a0,s6
 6d8:	f07ff0ef          	jal	5de <putc>
 6dc:	a019                	j	6e2 <vprintf+0x4a>
    } else if(state == '%'){
 6de:	03598263          	beq	s3,s5,702 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
 6e2:	2485                	addiw	s1,s1,1
 6e4:	8726                	mv	a4,s1
 6e6:	009a07b3          	add	a5,s4,s1
 6ea:	0007c903          	lbu	s2,0(a5)
 6ee:	22090a63          	beqz	s2,922 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
 6f2:	0009079b          	sext.w	a5,s2
    if(state == 0){
 6f6:	fe0994e3          	bnez	s3,6de <vprintf+0x46>
      if(c0 == '%'){
 6fa:	fd579de3          	bne	a5,s5,6d4 <vprintf+0x3c>
        state = '%';
 6fe:	89be                	mv	s3,a5
 700:	b7cd                	j	6e2 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
 702:	00ea06b3          	add	a3,s4,a4
 706:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
 70a:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
 70c:	c681                	beqz	a3,714 <vprintf+0x7c>
 70e:	9752                	add	a4,a4,s4
 710:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 714:	05878363          	beq	a5,s8,75a <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
 718:	05978d63          	beq	a5,s9,772 <vprintf+0xda>
 ...
 71c:	07500713          	li	a4,117
 720:	0ee78763          	beq	a5,a4,80e <vprintf+0x176>
 ...
 728:	12e78963          	beq	a5,a4,85a <vprintf+0x1c2>
 ...
 730:	14e78e63          	beq	a5,a4,88c <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 734:	06300713          	li	a4,99
 738:	18e78e63          	beq	a5,a4,8d4 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 73c:	07300713          	li	a4,115
 740:	1ae78463          	beq	a5,a4,8e8 <vprintf+0x250>
 ...
 748:	04e79563          	bne	a5,a4,792 <vprintf+0xfa>
        putc(fd, '%');
 ...
 766:	855a                	mv	a0,s6
 768:	e95ff0ef          	jal	5fc <printint>
 76c:	8bca                	mv	s7,s2
      state = 0;
 76e:	4981                	li	s3,0
 770:	bf8d                	j	6e2 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
 772:	06400793          	li	a5,100
 776:	02f68963          	beq	a3,a5,7a8 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 77a:	06c00793          	li	a5,108
 77e:	04f68263          	beq	a3,a5,7c2 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
 782:	07500793          	li	a5,117
 786:	0af68063          	beq	a3,a5,826 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
 78a:	07800793          	li	a5,120
 78e:	0ef68263          	beq	a3,a5,872 <vprintf+0x1da>
        putc(fd, '%');
 792:	02500593          	li	a1,37
 796:	855a                	mv	a0,s6
 798:	e47ff0ef          	jal	5de <putc>
        putc(fd, c0);
 79c:	85ca                	mv	a1,s2
 79e:	855a                	mv	a0,s6
 7a0:	e3fff0ef          	jal	5de <putc>
      state = 0;
 7a4:	4981                	li	s3,0
 7a6:	bf35                	j	6e2 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 7be:	4981                	li	s3,0
        i += 1;
 7c0:	b70d                	j	6e2 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 7c2:	06400793          	li	a5,100
 7c6:	02f60763          	beq	a2,a5,7f4 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 7ca:	07500793          	li	a5,117
 7ce:	06f60963          	beq	a2,a5,840 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 7d2:	07800793          	li	a5,120
 7d6:	faf61ee3          	bne	a2,a5,792 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 81a:	855a                	mv	a0,s6
 81c:	de1ff0ef          	jal	5fc <printint>
 820:	8bca                	mv	s7,s2
      state = 0;
 822:	4981                	li	s3,0
 824:	bd7d                	j	6e2 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 866:	855a                	mv	a0,s6
 868:	d95ff0ef          	jal	5fc <printint>
 86c:	8bca                	mv	s7,s2
      state = 0;
 86e:	4981                	li	s3,0
 870:	bd8d                	j	6e2 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 89a:	855a                	mv	a0,s6
 89c:	d43ff0ef          	jal	5de <putc>
  putc(fd, 'x');
 8a0:	07800593          	li	a1,120
 8a4:	855a                	mv	a0,s6
 8a6:	d39ff0ef          	jal	5de <putc>
 8aa:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 8ac:	00000b97          	auipc	s7,0x0
 8b0:	2b4b8b93          	addi	s7,s7,692 # b60 <digits>
 8b4:	03c9d793          	srli	a5,s3,0x3c
 8b8:	97de                	add	a5,a5,s7
 8ba:	0007c583          	lbu	a1,0(a5)
 8be:	855a                	mv	a0,s6
 8c0:	d1fff0ef          	jal	5de <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 8c4:	0992                	slli	s3,s3,0x4
 8c6:	397d                	addiw	s2,s2,-1
 8c8:	fe0916e3          	bnez	s2,8b4 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
 8cc:	8bea                	mv	s7,s10
      state = 0;
 8ce:	4981                	li	s3,0
 8d0:	6d02                	ld	s10,0(sp)
 8d2:	bd01                	j	6e2 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
 8d4:	008b8913          	addi	s2,s7,8
 8d8:	000bc583          	lbu	a1,0(s7)
 8dc:	855a                	mv	a0,s6
 8de:	d01ff0ef          	jal	5de <putc>
 8e2:	8bca                	mv	s7,s2
      state = 0;
 8e4:	4981                	li	s3,0
 8e6:	bbf5                	j	6e2 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
 8e8:	008b8993          	addi	s3,s7,8
 8ec:	000bb903          	ld	s2,0(s7)
 8f0:	00090f63          	beqz	s2,90e <vprintf+0x276>
        for(; *s; s++)
 8f4:	00094583          	lbu	a1,0(s2)
 8f8:	c195                	beqz	a1,91c <vprintf+0x284>
          putc(fd, *s);
 8fa:	855a                	mv	a0,s6
 8fc:	ce3ff0ef          	jal	5de <putc>
        for(; *s; s++)
 900:	0905                	addi	s2,s2,1
 902:	00094583          	lbu	a1,0(s2)
 906:	f9f5                	bnez	a1,8fa <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
 908:	8bce                	mv	s7,s3
      state = 0;
 90a:	4981                	li	s3,0
 90c:	bbd9                	j	6e2 <vprintf+0x4a>
          s = "(null)";
 90e:	00000917          	auipc	s2,0x0
 912:	24a90913          	addi	s2,s2,586 # b58 <malloc+0x13e>
        for(; *s; s++)
 916:	02800593          	li	a1,40
 91a:	b7c5                	j	8fa <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
 91c:	8bce                	mv	s7,s3
      state = 0;
 91e:	4981                	li	s3,0
 920:	b3c9                	j	6e2 <vprintf+0x4a>
...
malloc(uint nbytes)
{
 ...
 a6a:	59a90913          	addi	s2,s2,1434 # 1000 <freep>
  if(p == SBRK_ERROR)
 a6e:	5afd                	li	s5,-1
 ...
 a7e:	99678793          	addi	a5,a5,-1642 # 1410 <base>
