...
forktest(void)
{
  ...
  36:	42e50513          	addi	a0,a0,1070 # 460 <unshare+0xe>
  ...
  58:	45c50513          	addi	a0,a0,1116 # 4b0 <unshare+0x5e>
  ...
  6e:	40650513          	addi	a0,a0,1030 # 470 <unshare+0x1e>
  ...
  80:	40c50513          	addi	a0,a0,1036 # 488 <unshare+0x36>
  ...
  b0:	3f450513          	addi	a0,a0,1012 # 4a0 <unshare+0x4e>
...
0000000000000432 <set_pid_namespace>:
...
000000000000043a <get_pid_namespace>:
