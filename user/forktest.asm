...
forktest(void)
{
  ...
  36:	3fe50513          	addi	a0,a0,1022 # 430 <physaddr+0xe>
  ...
  58:	42c50513          	addi	a0,a0,1068 # 480 <physaddr+0x5e>
  ...
  6e:	3d650513          	addi	a0,a0,982 # 440 <physaddr+0x1e>
  ...
  80:	3dc50513          	addi	a0,a0,988 # 458 <physaddr+0x36>
  ...
  b0:	3c450513          	addi	a0,a0,964 # 470 <physaddr+0x4e>
