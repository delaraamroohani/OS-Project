...
000000000000037a <set_pid_namespace>:
...
0000000000000382 <get_pid_namespace>:
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3de:	50e50513          	addi	a0,a0,1294 # 8e8 <digits>
 3e2:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 674:	278b8b93          	addi	s7,s7,632 # 8e8 <digits>
 ...
 6d6:	20e90913          	addi	s2,s2,526 # 8e0 <malloc+0x102>
        for(; *s; s++)
