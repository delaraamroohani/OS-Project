...
main(int argc, char **argv)
{
  ...
  44:	8d058593          	addi	a1,a1,-1840 # 910 <malloc+0xfc>
  48:	4509                	li	a0,2
...
00000000000003b0 <set_pid_namespace>:
...
00000000000003b8 <get_pid_namespace>:
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6aa:	28ab8b93          	addi	s7,s7,650 # 930 <digits>
 ...
 70c:	22090913          	addi	s2,s2,544 # 928 <malloc+0x114>
        for(; *s; s++)
