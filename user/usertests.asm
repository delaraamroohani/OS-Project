...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	91278793          	addi	a5,a5,-1774 # 7920 <malloc+0x2680>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	33a50513          	addi	a0,a0,826 # 53a0 <malloc+0x100>
      6e:	17e050ef          	jal	51ec <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	32050513          	addi	a0,a0,800 # 53c0 <malloc+0x120>
      a8:	144050ef          	jal	51ec <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	31850513          	addi	a0,a0,792 # 53d8 <malloc+0x138>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	32250513          	addi	a0,a0,802 # 53f8 <malloc+0x158>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	2ee50513          	addi	a0,a0,750 # 53e0 <malloc+0x140>
      fa:	0f2050ef          	jal	51ec <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	30250513          	addi	a0,a0,770 # 5408 <malloc+0x168>
     10e:	0de050ef          	jal	51ec <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	2b450513          	addi	a0,a0,692 # 5430 <malloc+0x190>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	2aa50513          	addi	a0,a0,682 # 5450 <malloc+0x1b0>
     1ae:	03e050ef          	jal	51ec <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	23450513          	addi	a0,a0,564 # 5478 <malloc+0x1d8>
     24c:	379040ef          	jal	4dc4 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	224a8a93          	addi	s5,s5,548 # 5478 <malloc+0x1d8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	1c650513          	addi	a0,a0,454 # 5488 <malloc+0x1e8>
     2ca:	723040ef          	jal	51ec <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	1cc50513          	addi	a0,a0,460 # 54a8 <malloc+0x208>
     2e4:	709040ef          	jal	51ec <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	1c250513          	addi	a0,a0,450 # 54c0 <malloc+0x220>
     306:	2bf040ef          	jal	4dc4 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	1b298993          	addi	s3,s3,434 # 54c0 <malloc+0x220>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	17650513          	addi	a0,a0,374 # 54c0 <malloc+0x220>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	0ea58593          	addi	a1,a1,234 # 5448 <malloc+0x1a8>
     366:	22f040ef          	jal	4d94 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	17050513          	addi	a0,a0,368 # 54e0 <malloc+0x240>
     378:	675040ef          	jal	51ec <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	1f7040ef          	jal	4d74 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	14650513          	addi	a0,a0,326 # 54c8 <malloc+0x228>
     38a:	663040ef          	jal	51ec <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	1e5040ef          	jal	4d74 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	13450513          	addi	a0,a0,308 # 54c8 <malloc+0x228>
     39c:	651040ef          	jal	51ec <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	11450513          	addi	a0,a0,276 # 54c0 <malloc+0x220>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	49078793          	addi	a5,a5,1168 # 7920 <malloc+0x2680>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	032a0a13          	addi	s4,s4,50 # 54f0 <malloc+0x250>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	fb450513          	addi	a0,a0,-76 # 54f8 <malloc+0x258>
     54c:	4a1040ef          	jal	51ec <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	fb650513          	addi	a0,a0,-74 # 5510 <malloc+0x270>
     562:	48b040ef          	jal	51ec <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	fd050513          	addi	a0,a0,-48 # 5540 <malloc+0x2a0>
     578:	475040ef          	jal	51ec <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	7f6040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	fee50513          	addi	a0,a0,-18 # 5570 <malloc+0x2d0>
     58a:	463040ef          	jal	51ec <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	fe850513          	addi	a0,a0,-24 # 5580 <malloc+0x2e0>
     5a0:	44d040ef          	jal	51ec <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	36278793          	addi	a5,a5,866 # 7920 <malloc+0x2680>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	fbea0a13          	addi	s4,s4,-66 # 55b0 <malloc+0x310>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	e4ea8a93          	addi	s5,s5,-434 # 5448 <malloc+0x1a8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	f3a50513          	addi	a0,a0,-198 # 55b8 <malloc+0x318>
     686:	367040ef          	jal	51ec <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	f3c50513          	addi	a0,a0,-196 # 55d0 <malloc+0x330>
     69c:	351040ef          	jal	51ec <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	6d2040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	eca50513          	addi	a0,a0,-310 # 5570 <malloc+0x2d0>
     6ae:	33f040ef          	jal	51ec <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	6c0040ef          	jal	4d74 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	f4850513          	addi	a0,a0,-184 # 5600 <malloc+0x360>
     6c0:	32d040ef          	jal	51ec <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	f4a50513          	addi	a0,a0,-182 # 5618 <malloc+0x378>
     6d6:	317040ef          	jal	51ec <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	d0850513          	addi	a0,a0,-760 # 5430 <malloc+0x190>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	ce450513          	addi	a0,a0,-796 # 5430 <malloc+0x190>
     754:	660040ef          	jal	4db4 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	cd450513          	addi	a0,a0,-812 # 5430 <malloc+0x190>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	f1a58593          	addi	a1,a1,-230 # 56a8 <malloc+0x408>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	c6c50513          	addi	a0,a0,-916 # 5430 <malloc+0x190>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	e5050513          	addi	a0,a0,-432 # 5648 <malloc+0x3a8>
     800:	1ed040ef          	jal	51ec <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	e5c50513          	addi	a0,a0,-420 # 5668 <malloc+0x3c8>
     814:	1d9040ef          	jal	51ec <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	e5c50513          	addi	a0,a0,-420 # 5678 <malloc+0x3d8>
     824:	1c9040ef          	jal	51ec <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	e6850513          	addi	a0,a0,-408 # 5698 <malloc+0x3f8>
     838:	1b5040ef          	jal	51ec <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	e3850513          	addi	a0,a0,-456 # 5678 <malloc+0x3d8>
     848:	1a5040ef          	jal	51ec <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	e5a50513          	addi	a0,a0,-422 # 56b0 <malloc+0x410>
     85e:	18f040ef          	jal	51ec <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	e6450513          	addi	a0,a0,-412 # 56d0 <malloc+0x430>
     874:	179040ef          	jal	51ec <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	e5850513          	addi	a0,a0,-424 # 56f0 <malloc+0x450>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	e6c98993          	addi	s3,s3,-404 # 5718 <malloc+0x478>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	e9ca8a93          	addi	s5,s5,-356 # 5750 <malloc+0x4b0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	e0250513          	addi	a0,a0,-510 # 56f0 <malloc+0x450>
  ...
  if(unlink("small") < 0){
     ...
     922:	dd250513          	addi	a0,a0,-558 # 56f0 <malloc+0x450>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	db450513          	addi	a0,a0,-588 # 56f8 <malloc+0x458>
     94c:	0a1040ef          	jal	51ec <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	dce50513          	addi	a0,a0,-562 # 5728 <malloc+0x488>
     962:	08b040ef          	jal	51ec <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	df050513          	addi	a0,a0,-528 # 5760 <malloc+0x4c0>
     978:	075040ef          	jal	51ec <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	e0450513          	addi	a0,a0,-508 # 5788 <malloc+0x4e8>
     98c:	061040ef          	jal	51ec <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	e1050513          	addi	a0,a0,-496 # 57a8 <malloc+0x508>
     9a0:	04d040ef          	jal	51ec <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	e1450513          	addi	a0,a0,-492 # 57c0 <malloc+0x520>
     9b4:	039040ef          	jal	51ec <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	e0a50513          	addi	a0,a0,-502 # 57e0 <malloc+0x540>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	dc450513          	addi	a0,a0,-572 # 57e0 <malloc+0x540>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	d8c50513          	addi	a0,a0,-628 # 57e8 <malloc+0x548>
     a64:	788040ef          	jal	51ec <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	d9650513          	addi	a0,a0,-618 # 5808 <malloc+0x568>
     a7a:	772040ef          	jal	51ec <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	daa50513          	addi	a0,a0,-598 # 5830 <malloc+0x590>
     a8e:	75e040ef          	jal	51ec <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	d3a50513          	addi	a0,a0,-710 # 57e0 <malloc+0x540>
     ...
     ad0:	d8450513          	addi	a0,a0,-636 # 5850 <malloc+0x5b0>
     ad4:	718040ef          	jal	51ec <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	d9650513          	addi	a0,a0,-618 # 5878 <malloc+0x5d8>
     aea:	702040ef          	jal	51ec <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	d9850513          	addi	a0,a0,-616 # 5890 <malloc+0x5f0>
     b00:	6ec040ef          	jal	51ec <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	dac50513          	addi	a0,a0,-596 # 58b8 <malloc+0x618>
     b14:	6d8040ef          	jal	51ec <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	d9e50513          	addi	a0,a0,-610 # 58d0 <malloc+0x630>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	dba58593          	addi	a1,a1,-582 # 5900 <malloc+0x660>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	d7650513          	addi	a0,a0,-650 # 58d0 <malloc+0x630>
  ...
  unlink("unlinkread");
     ...
     be6:	cee50513          	addi	a0,a0,-786 # 58d0 <malloc+0x630>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	ce250513          	addi	a0,a0,-798 # 58e0 <malloc+0x640>
     c06:	5e6040ef          	jal	51ec <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	cf650513          	addi	a0,a0,-778 # 5908 <malloc+0x668>
     c1a:	5d2040ef          	jal	51ec <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	d0250513          	addi	a0,a0,-766 # 5928 <malloc+0x688>
     c2e:	5be040ef          	jal	51ec <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	d1650513          	addi	a0,a0,-746 # 5950 <malloc+0x6b0>
     c42:	5aa040ef          	jal	51ec <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	d2250513          	addi	a0,a0,-734 # 5970 <malloc+0x6d0>
     c56:	596040ef          	jal	51ec <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	d2e50513          	addi	a0,a0,-722 # 5990 <malloc+0x6f0>
     c6a:	582040ef          	jal	51ec <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	d2e50513          	addi	a0,a0,-722 # 59b0 <malloc+0x710>
     c8a:	13a040ef          	jal	4dc4 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	d2a50513          	addi	a0,a0,-726 # 59b8 <malloc+0x718>
     c96:	12e040ef          	jal	4dc4 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	d1250513          	addi	a0,a0,-750 # 59b0 <malloc+0x710>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	c4e58593          	addi	a1,a1,-946 # 5900 <malloc+0x660>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	c3650513          	addi	a0,a0,-970 # 59c0 <malloc+0x720>
     d92:	45a040ef          	jal	51ec <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	c3a50513          	addi	a0,a0,-966 # 59d8 <malloc+0x738>
     da6:	446040ef          	jal	51ec <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	c3e50513          	addi	a0,a0,-962 # 59f0 <malloc+0x750>
     dba:	432040ef          	jal	51ec <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	c4a50513          	addi	a0,a0,-950 # 5a10 <malloc+0x770>
     dce:	41e040ef          	jal	51ec <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	c6650513          	addi	a0,a0,-922 # 5a40 <malloc+0x7a0>
     de2:	40a040ef          	jal	51ec <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	c6a50513          	addi	a0,a0,-918 # 5a58 <malloc+0x7b8>
     df6:	3f6040ef          	jal	51ec <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	c6e50513          	addi	a0,a0,-914 # 5a70 <malloc+0x7d0>
     e0a:	3e2040ef          	jal	51ec <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	c8250513          	addi	a0,a0,-894 # 5a98 <malloc+0x7f8>
     e1e:	3ce040ef          	jal	51ec <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	c9e50513          	addi	a0,a0,-866 # 5ac8 <malloc+0x828>
     e32:	3ba040ef          	jal	51ec <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	c9498993          	addi	s3,s3,-876 # 5ae8 <malloc+0x848>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	c6c50513          	addi	a0,a0,-916 # 5af8 <malloc+0x858>
     e94:	358040ef          	jal	51ec <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	c6450513          	addi	a0,a0,-924 # 5b18 <malloc+0x878>
     ebc:	709030ef          	jal	4dc4 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	c5450513          	addi	a0,a0,-940 # 5b18 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	c3aa0a13          	addi	s4,s4,-966 # 5b18 <malloc+0x878>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	bec50513          	addi	a0,a0,-1044 # 5b18 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	b8c50513          	addi	a0,a0,-1140 # 5b20 <malloc+0x880>
     f9c:	250040ef          	jal	51ec <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	b9250513          	addi	a0,a0,-1134 # 5b40 <malloc+0x8a0>
     fb6:	236040ef          	jal	51ec <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	ba650513          	addi	a0,a0,-1114 # 5b68 <malloc+0x8c8>
     fca:	222040ef          	jal	51ec <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	3be98993          	addi	s3,s3,958 # 53d8 <malloc+0x138>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	c2878793          	addi	a5,a5,-984 # 6cb8 <malloc+0x1a18>
  ...
  if(pid == 0){
    ...
    10e8:	83c78793          	addi	a5,a5,-1988 # 7920 <malloc+0x2680>
    ...
    110c:	2d050513          	addi	a0,a0,720 # 53d8 <malloc+0x138>
    ...
    1120:	af450513          	addi	a0,a0,-1292 # 5c10 <malloc+0x970>
    1124:	0c8040ef          	jal	51ec <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	a5450513          	addi	a0,a0,-1452 # 5b88 <malloc+0x8e8>
    113c:	0b0040ef          	jal	51ec <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	a5c50513          	addi	a0,a0,-1444 # 5ba8 <malloc+0x908>
    1154:	098040ef          	jal	51ec <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	a6250513          	addi	a0,a0,-1438 # 5bc8 <malloc+0x928>
    116e:	07e040ef          	jal	51ec <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	a7250513          	addi	a0,a0,-1422 # 5bf0 <malloc+0x950>
    1186:	066040ef          	jal	51ec <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	3e9030ef          	jal	4d74 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	08050513          	addi	a0,a0,128 # 7210 <malloc+0x1f70>
    1198:	054040ef          	jal	51ec <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	a6e50513          	addi	a0,a0,-1426 # 5c38 <malloc+0x998>
    11d2:	01a040ef          	jal	51ec <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	24450513          	addi	a0,a0,580 # 5430 <malloc+0x190>
  ...
  if(pid == 0){
    ...
    1216:	21ea0a13          	addi	s4,s4,542 # 5430 <malloc+0x190>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	a7ea8a93          	addi	s5,s5,-1410 # 5c98 <malloc+0x9f8>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	9f250513          	addi	a0,a0,-1550 # 5c68 <malloc+0x9c8>
    127e:	76f030ef          	jal	51ec <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	9f650513          	addi	a0,a0,-1546 # 5c80 <malloc+0x9e0>
    1292:	75b030ef          	jal	51ec <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	a0850513          	addi	a0,a0,-1528 # 5ca8 <malloc+0xa08>
    12a8:	745030ef          	jal	51ec <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	172a0a13          	addi	s4,s4,370 # 5430 <malloc+0x190>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	a02a8a93          	addi	s5,s5,-1534 # 5cc8 <malloc+0xa28>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	13050513          	addi	a0,a0,304 # 5430 <malloc+0x190>
  ...
  exit(xstatus);
    ...
    131a:	96a50513          	addi	a0,a0,-1686 # 5c80 <malloc+0x9e0>
    131e:	6cf030ef          	jal	51ec <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	9a450513          	addi	a0,a0,-1628 # 5cd0 <malloc+0xa30>
    1334:	6b9030ef          	jal	51ec <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	08e78793          	addi	a5,a5,142 # 53d8 <malloc+0x138>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	99a78793          	addi	a5,a5,-1638 # 5cf0 <malloc+0xa50>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	99250513          	addi	a0,a0,-1646 # 5cf8 <malloc+0xa58>
  ...
  if(pid == 0) {
    ...
    138e:	96e50513          	addi	a0,a0,-1682 # 5cf8 <malloc+0xa58>
    ...
    13a6:	97650513          	addi	a0,a0,-1674 # 5d18 <malloc+0xa78>
    13aa:	643030ef          	jal	51ec <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	8b050513          	addi	a0,a0,-1872 # 5c68 <malloc+0x9c8>
    13c0:	62d030ef          	jal	51ec <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	93450513          	addi	a0,a0,-1740 # 5d00 <malloc+0xa60>
    13d4:	619030ef          	jal	51ec <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	ff650513          	addi	a0,a0,-10 # 53d8 <malloc+0x138>
  ...
  if(xstatus != 0)
    ...
    140e:	91e50513          	addi	a0,a0,-1762 # 5d28 <malloc+0xa88>
    1412:	5db030ef          	jal	51ec <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	92250513          	addi	a0,a0,-1758 # 5d40 <malloc+0xaa0>
    1426:	5c7030ef          	jal	51ec <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00005517          	auipc	a0,0x5
    1432:	8ca50513          	addi	a0,a0,-1846 # 5cf8 <malloc+0xa58>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	35850513          	addi	a0,a0,856 # 57a8 <malloc+0x508>
    1458:	595030ef          	jal	51ec <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	81c50513          	addi	a0,a0,-2020 # 5c80 <malloc+0x9e0>
    146c:	581030ef          	jal	51ec <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	103030ef          	jal	4d74 <exit>
  unlink("echo-ok");
    1476:	00005517          	auipc	a0,0x5
    147a:	88250513          	addi	a0,a0,-1918 # 5cf8 <malloc+0xa58>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	8bc50513          	addi	a0,a0,-1860 # 5d58 <malloc+0xab8>
    14a4:	549030ef          	jal	51ec <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	82850513          	addi	a0,a0,-2008 # 5d70 <malloc+0xad0>
    1550:	49d030ef          	jal	51ec <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	7c650513          	addi	a0,a0,1990 # 5d88 <malloc+0xae8>
    15ca:	423030ef          	jal	51ec <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	7ca50513          	addi	a0,a0,1994 # 5da0 <malloc+0xb00>
    15de:	40f030ef          	jal	51ec <printf>
          return;
    ...
    160a:	7b250513          	addi	a0,a0,1970 # 5db8 <malloc+0xb18>
    160e:	3df030ef          	jal	51ec <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	79a50513          	addi	a0,a0,1946 # 5dd8 <malloc+0xb38>
    1646:	3a7030ef          	jal	51ec <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	5c850513          	addi	a0,a0,1480 # 5c68 <malloc+0x9c8>
    16a8:	345030ef          	jal	51ec <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	73c50513          	addi	a0,a0,1852 # 5df0 <malloc+0xb50>
    16bc:	331030ef          	jal	51ec <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	74050513          	addi	a0,a0,1856 # 5e08 <malloc+0xb68>
    16d0:	31d030ef          	jal	51ec <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	54450513          	addi	a0,a0,1348 # 5c68 <malloc+0x9c8>
    172c:	2c1030ef          	jal	51ec <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	52c50513          	addi	a0,a0,1324 # 5c68 <malloc+0x9c8>
    1744:	2a9030ef          	jal	51ec <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	68e50513          	addi	a0,a0,1678 # 5e28 <malloc+0xb88>
    17a2:	24b030ef          	jal	51ec <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	5cc030ef          	jal	4d74 <exit>
{
    ...
    17da:	66250513          	addi	a0,a0,1634 # 5e38 <malloc+0xb98>
    17de:	20f030ef          	jal	51ec <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	a0050513          	addi	a0,a0,-1536 # 7210 <malloc+0x1f70>
    1818:	1d5030ef          	jal	51ec <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	3d650513          	addi	a0,a0,982 # 5c68 <malloc+0x9c8>
    189a:	153030ef          	jal	51ec <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	44a50513          	addi	a0,a0,1098 # 5d00 <malloc+0xa60>
    18be:	12f030ef          	jal	51ec <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    1918:	54450513          	addi	a0,a0,1348 # 5e58 <malloc+0xbb8>
    191c:	0d1030ef          	jal	51ec <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	53850513          	addi	a0,a0,1336 # 5e70 <malloc+0xbd0>
    1940:	0ad030ef          	jal	51ec <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	50e50513          	addi	a0,a0,1294 # 5e98 <malloc+0xbf8>
    1992:	05b030ef          	jal	51ec <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	a2450513          	addi	a0,a0,-1500 # 5448 <malloc+0x1a8>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	9f0b0b13          	addi	s6,s6,-1552 # 5448 <malloc+0x1a8>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	460c0c13          	addi	s8,s8,1120 # 5ec0 <malloc+0xc20>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	1fc50513          	addi	a0,a0,508 # 5c68 <malloc+0x9c8>
    1a74:	778030ef          	jal	51ec <printf>
    exit(1);
    1a78:	4505                	li	a0,1
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	40450513          	addi	a0,a0,1028 # 5f10 <malloc+0xc70>
    1b14:	6d8030ef          	jal	51ec <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	3a450513          	addi	a0,a0,932 # 5ec8 <malloc+0xc28>
    1b2c:	6c0030ef          	jal	51ec <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	3a850513          	addi	a0,a0,936 # 5ee0 <malloc+0xc40>
    1b40:	6ac030ef          	jal	51ec <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	3ac50513          	addi	a0,a0,940 # 5ef8 <malloc+0xc58>
    1b54:	698030ef          	jal	51ec <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	07e50513          	addi	a0,a0,126 # 5c68 <malloc+0x9c8>
    1bf2:	5fa030ef          	jal	51ec <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	33450513          	addi	a0,a0,820 # 5f38 <malloc+0xc98>
    1c0c:	5e0030ef          	jal	51ec <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	ff650513          	addi	a0,a0,-10 # 5c68 <malloc+0x9c8>
    1c7a:	572030ef          	jal	51ec <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	2c250513          	addi	a0,a0,706 # 5f58 <malloc+0xcb8>
    1c9e:	54e030ef          	jal	51ec <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	28a50513          	addi	a0,a0,650 # 5f70 <malloc+0xcd0>
    1cee:	4fe030ef          	jal	51ec <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	f6e50513          	addi	a0,a0,-146 # 5c68 <malloc+0x9c8>
    1d02:	4ea030ef          	jal	51ec <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	bfe78793          	addi	a5,a5,-1026 # 7920 <malloc+0x2680>
  ...
  exit(0);
    ...
    1d8e:	20e50513          	addi	a0,a0,526 # 5f98 <malloc+0xcf8>
    1d92:	45a030ef          	jal	51ec <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	eca50513          	addi	a0,a0,-310 # 5c68 <malloc+0x9c8>
    1da6:	446030ef          	jal	51ec <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	40650513          	addi	a0,a0,1030 # 7210 <malloc+0x1f70>
    1e12:	3da030ef          	jal	51ec <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	11c50513          	addi	a0,a0,284 # 5fb8 <malloc+0xd18>
    1ea4:	348030ef          	jal	51ec <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	5f450513          	addi	a0,a0,1524 # 54a8 <malloc+0x208>
    1ebc:	330030ef          	jal	51ec <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	d9078793          	addi	a5,a5,-624 # 6cb8 <malloc+0x1a18>
  ...
  if(ret != -1){
    ...
    1f66:	06e50513          	addi	a0,a0,110 # 5fd0 <malloc+0xd30>
    1f6a:	282030ef          	jal	51ec <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	c1050513          	addi	a0,a0,-1008 # 5b88 <malloc+0x8e8>
    1f80:	26c030ef          	jal	51ec <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	c1a50513          	addi	a0,a0,-998 # 5ba8 <malloc+0x908>
    1f96:	256030ef          	jal	51ec <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	c2250513          	addi	a0,a0,-990 # 5bc8 <malloc+0x928>
    1fae:	23e030ef          	jal	51ec <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	c3450513          	addi	a0,a0,-972 # 5bf0 <malloc+0x950>
    1fc4:	228030ef          	jal	51ec <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	01850513          	addi	a0,a0,24 # 6010 <malloc+0xd70>
  ...
  if(n >= 0){
    ...
    2024:	01050513          	addi	a0,a0,16 # 6030 <malloc+0xd90>
    2028:	1c4030ef          	jal	51ec <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	fa250513          	addi	a0,a0,-94 # 5fd8 <malloc+0xd38>
    203e:	1ae030ef          	jal	51ec <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	fa650513          	addi	a0,a0,-90 # 5ff0 <malloc+0xd50>
    2052:	19a030ef          	jal	51ec <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	51d020ef          	jal	4d74 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	fbc50513          	addi	a0,a0,-68 # 6018 <malloc+0xd78>
    2064:	188030ef          	jal	51ec <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	f9c50513          	addi	a0,a0,-100 # 6010 <malloc+0xd70>
    207c:	549020ef          	jal	4dc4 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	52e50513          	addi	a0,a0,1326 # 55b0 <malloc+0x310>
  ...
  if(n >= 0){
    ...
    20a8:	fbc50513          	addi	a0,a0,-68 # 6060 <malloc+0xdc0>
    20ac:	140030ef          	jal	51ec <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	4c3020ef          	jal	4d74 <exit>
    printf("open(README) failed\n");
    20b6:	00003517          	auipc	a0,0x3
    20ba:	50250513          	addi	a0,a0,1282 # 55b8 <malloc+0x318>
    20be:	12e030ef          	jal	51ec <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	f6850513          	addi	a0,a0,-152 # 6088 <malloc+0xde8>
    2128:	0c4030ef          	jal	51ec <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	f3850513          	addi	a0,a0,-200 # 60a8 <malloc+0xe08>
    2178:	074030ef          	jal	51ec <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	f4c50513          	addi	a0,a0,-180 # 6108 <malloc+0xe68>
    21c4:	028030ef          	jal	51ec <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	ef250513          	addi	a0,a0,-270 # 60c8 <malloc+0xe28>
    21de:	00e030ef          	jal	51ec <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	efe50513          	addi	a0,a0,-258 # 60e8 <malloc+0xe48>
    21f2:	7fb020ef          	jal	51ec <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	e5650513          	addi	a0,a0,-426 # 6128 <malloc+0xe88>
    22da:	713020ef          	jal	51ec <printf>
    exit(1);
    22de:	4505                	li	a0,1
    ...
    22ea:	e8a50513          	addi	a0,a0,-374 # 6170 <malloc+0xed0>
    22ee:	6ff020ef          	jal	51ec <printf>
    exit(1);
    22f2:	4505                	li	a0,1
    ...
    2302:	e9250513          	addi	a0,a0,-366 # 6190 <malloc+0xef0>
    2306:	6e7020ef          	jal	51ec <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    231a:	eba50513          	addi	a0,a0,-326 # 61d0 <malloc+0xf30>
    231e:	6cf020ef          	jal	51ec <printf>
    exit(1);
    2322:	4505                	li	a0,1
    ...
    232e:	ed650513          	addi	a0,a0,-298 # 6200 <malloc+0xf60>
    2332:	6bb020ef          	jal	51ec <printf>
    exit(1);
    2336:	4505                	li	a0,1
    ...
    2346:	ef650513          	addi	a0,a0,-266 # 6238 <malloc+0xf98>
    234a:	6a3020ef          	jal	51ec <printf>
    exit(1);
    234e:	4505                	li	a0,1
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	ef050513          	addi	a0,a0,-272 # 6260 <malloc+0xfc0>
    2378:	23d020ef          	jal	4db4 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	ee250513          	addi	a0,a0,-286 # 6260 <malloc+0xfc0>
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	eaa50513          	addi	a0,a0,-342 # 6268 <malloc+0xfc8>
    23c6:	627020ef          	jal	51ec <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23d6:	eae50513          	addi	a0,a0,-338 # 6280 <malloc+0xfe0>
    23da:	613020ef          	jal	51ec <printf>
    exit(1);
    23de:	4505                	li	a0,1
    ...
    23ea:	98a50513          	addi	a0,a0,-1654 # 5d70 <malloc+0xad0>
    23ee:	5ff020ef          	jal	51ec <printf>
    exit(1);
    23f2:	4505                	li	a0,1
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	e9050513          	addi	a0,a0,-368 # 6298 <malloc+0xff8>
  ...
  close(fd);
    ...
    2444:	84050513          	addi	a0,a0,-1984 # 5c80 <malloc+0x9e0>
    2448:	5a5020ef          	jal	51ec <printf>
    exit(1);
    244c:	4505                	li	a0,1
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	d9a50513          	addi	a0,a0,-614 # 7210 <malloc+0x1f70>
    247e:	56f020ef          	jal	51ec <printf>
    exit(1);
    2482:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24b4:	d6050513          	addi	a0,a0,-672 # 7210 <malloc+0x1f70>
    24b8:	535020ef          	jal	51ec <printf>
    exit(1);
    24bc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24f4:	d2050513          	addi	a0,a0,-736 # 7210 <malloc+0x1f70>
    24f8:	4f5020ef          	jal	51ec <printf>
    exit(1);
    24fc:	4505                	li	a0,1
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	c0050513          	addi	a0,a0,-1024 # 7210 <malloc+0x1f70>
    2618:	3d5020ef          	jal	51ec <printf>
      exit(1);
    261c:	4505                	li	a0,1
    ...
    2654:	d8850513          	addi	a0,a0,-632 # 53d8 <malloc+0x138>
    2658:	faa43c23          	sd	a0,-72(s0)
    265c:	00003797          	auipc	a5,0x3
    2660:	dec78793          	addi	a5,a5,-532 # 5448 <malloc+0x1a8>
...
000000000000267a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26aa:	c7a50513          	addi	a0,a0,-902 # 6320 <malloc+0x1080>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26c0:	cdc50513          	addi	a0,a0,-804 # 6398 <malloc+0x10f8>
  ...
  unlink("12345678901234");
    ...
    2744:	b6050513          	addi	a0,a0,-1184 # 62a0 <malloc+0x1000>
    2748:	2a5020ef          	jal	51ec <printf>
    exit(1);
    274c:	4505                	li	a0,1
    ...
    2758:	b9450513          	addi	a0,a0,-1132 # 62e8 <malloc+0x1048>
    275c:	291020ef          	jal	51ec <printf>
    exit(1);
    2760:	4505                	li	a0,1
    ...
    276c:	be850513          	addi	a0,a0,-1048 # 6350 <malloc+0x10b0>
    2770:	27d020ef          	jal	51ec <printf>
    exit(1);
    2774:	4505                	li	a0,1
    ...
    2780:	c4c50513          	addi	a0,a0,-948 # 63c8 <malloc+0x1128>
    2784:	269020ef          	jal	51ec <printf>
    exit(1);
    2788:	4505                	li	a0,1
    ...
    2794:	c9850513          	addi	a0,a0,-872 # 6428 <malloc+0x1188>
    2798:	255020ef          	jal	51ec <printf>
    exit(1);
    279c:	4505                	li	a0,1
    ...
    27a8:	cdc50513          	addi	a0,a0,-804 # 6480 <malloc+0x11e0>
    27ac:	241020ef          	jal	51ec <printf>
    exit(1);
    27b0:	4505                	li	a0,1
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	ccc50513          	addi	a0,a0,-820 # 64b8 <malloc+0x1218>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	cb050513          	addi	a0,a0,-848 # 64c8 <malloc+0x1228>
    2820:	1cd020ef          	jal	51ec <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29c0:	b2c50513          	addi	a0,a0,-1236 # 64e8 <malloc+0x1248>
    29c4:	029020ef          	jal	51ec <printf>
...
00000000000029ca <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a26:	afe50513          	addi	a0,a0,-1282 # 6520 <malloc+0x1280>
    2a2a:	7c2020ef          	jal	51ec <printf>
    exit(1);
    2a2e:	4505                	li	a0,1
    ...
    2a3a:	b0250513          	addi	a0,a0,-1278 # 6538 <malloc+0x1298>
    2a3e:	7ae020ef          	jal	51ec <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    ...
    2a4e:	b1e50513          	addi	a0,a0,-1250 # 6568 <malloc+0x12c8>
    2a52:	79a020ef          	jal	51ec <printf>
    exit(1);
    2a56:	4505                	li	a0,1
    ...
    2a62:	b3250513          	addi	a0,a0,-1230 # 6590 <malloc+0x12f0>
    2a66:	786020ef          	jal	51ec <printf>
    exit(1);
    2a6a:	4505                	li	a0,1
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ac2:	1aa50513          	addi	a0,a0,426 # 5c68 <malloc+0x9c8>
    2ac6:	726020ef          	jal	51ec <printf>
    exit(1);
    2aca:	4505                	li	a0,1
    ...
    2ad6:	a4e50513          	addi	a0,a0,-1458 # 6520 <malloc+0x1280>
    2ada:	712020ef          	jal	51ec <printf>
      exit(1);
    2ade:	4505                	li	a0,1
    ...
    2aea:	ac250513          	addi	a0,a0,-1342 # 65a8 <malloc+0x1308>
    2aee:	6fe020ef          	jal	51ec <printf>
      exit(1);
    2af2:	4505                	li	a0,1
    ...
    2afe:	a6e50513          	addi	a0,a0,-1426 # 6568 <malloc+0x12c8>
    2b02:	6ea020ef          	jal	51ec <printf>
      exit(1);
    2b06:	4505                	li	a0,1
...
0000000000002b1c <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b78:	9ac50513          	addi	a0,a0,-1620 # 6520 <malloc+0x1280>
    2b7c:	670020ef          	jal	51ec <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	a4050513          	addi	a0,a0,-1472 # 65c8 <malloc+0x1328>
    2b90:	65c020ef          	jal	51ec <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	a4c50513          	addi	a0,a0,-1460 # 65e8 <malloc+0x1348>
    2ba4:	648020ef          	jal	51ec <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bb4:	a5050513          	addi	a0,a0,-1456 # 6600 <malloc+0x1360>
    2bb8:	634020ef          	jal	51ec <printf>
    exit(1);
    2bbc:	4505                	li	a0,1
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	b7850513          	addi	a0,a0,-1160 # 6748 <malloc+0x14a8>
    2bd8:	1ec020ef          	jal	4dc4 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	a3c50513          	addi	a0,a0,-1476 # 6618 <malloc+0x1378>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bf4:	a4850513          	addi	a0,a0,-1464 # 6638 <malloc+0x1398>
  ...
  write(fd, "ff", 2);
    ...
    2c08:	b4458593          	addi	a1,a1,-1212 # 6748 <malloc+0x14a8>
  ...
  if(unlink("dd") >= 0){
    ...
    2c1a:	a0250513          	addi	a0,a0,-1534 # 6618 <malloc+0x1378>
    2c1e:	1a6020ef          	jal	4dc4 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	a6a50513          	addi	a0,a0,-1430 # 6690 <malloc+0x13f0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c3e:	a7e50513          	addi	a0,a0,-1410 # 66b8 <malloc+0x1418>
  ...
  write(fd, "FF", 2);
    ...
    2c52:	a9a58593          	addi	a1,a1,-1382 # 66e8 <malloc+0x1448>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c66:	a8e50513          	addi	a0,a0,-1394 # 66f0 <malloc+0x1450>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d4c:	97050513          	addi	a0,a0,-1680 # 66b8 <malloc+0x1418>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d60:	b7450513          	addi	a0,a0,-1164 # 68d0 <malloc+0x1630>
  ...
  if(unlink("dd") < 0){
    ...
    2ed2:	75250513          	addi	a0,a0,1874 # 6620 <malloc+0x1380>
    2ed6:	316020ef          	jal	51ec <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    ...
    2ee6:	75e50513          	addi	a0,a0,1886 # 6640 <malloc+0x13a0>
    2eea:	302020ef          	jal	51ec <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    ...
    2efa:	76a50513          	addi	a0,a0,1898 # 6660 <malloc+0x13c0>
    2efe:	2ee020ef          	jal	51ec <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f0e:	78e50513          	addi	a0,a0,1934 # 6698 <malloc+0x13f8>
    2f12:	2da020ef          	jal	51ec <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f22:	7aa50513          	addi	a0,a0,1962 # 66c8 <malloc+0x1428>
    2f26:	2c6020ef          	jal	51ec <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    ...
    2f36:	7ce50513          	addi	a0,a0,1998 # 6700 <malloc+0x1460>
    2f3a:	2b2020ef          	jal	51ec <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    ...
    2f4a:	7da50513          	addi	a0,a0,2010 # 6720 <malloc+0x1480>
    2f4e:	29e020ef          	jal	51ec <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f5e:	7f650513          	addi	a0,a0,2038 # 6750 <malloc+0x14b0>
    2f62:	28a020ef          	jal	51ec <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    ...
    2f72:	80a50513          	addi	a0,a0,-2038 # 6778 <malloc+0x14d8>
    2f76:	276020ef          	jal	51ec <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    ...
    2f86:	81650513          	addi	a0,a0,-2026 # 6798 <malloc+0x14f8>
    2f8a:	262020ef          	jal	51ec <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    ...
    2f9a:	82a50513          	addi	a0,a0,-2006 # 67c0 <malloc+0x1520>
    2f9e:	24e020ef          	jal	51ec <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    ...
    2fae:	83e50513          	addi	a0,a0,-1986 # 67e8 <malloc+0x1548>
    2fb2:	23a020ef          	jal	51ec <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2fc2:	85a50513          	addi	a0,a0,-1958 # 6818 <malloc+0x1578>
    2fc6:	226020ef          	jal	51ec <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    ...
    2fd6:	87650513          	addi	a0,a0,-1930 # 6848 <malloc+0x15a8>
    2fda:	212020ef          	jal	51ec <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    ...
    2fea:	87a50513          	addi	a0,a0,-1926 # 6860 <malloc+0x15c0>
    2fee:	1fe020ef          	jal	51ec <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    2ffe:	88650513          	addi	a0,a0,-1914 # 6880 <malloc+0x15e0>
    3002:	1ea020ef          	jal	51ec <printf>
    exit(1);
    3006:	4505                	li	a0,1
    ...
    3012:	89250513          	addi	a0,a0,-1902 # 68a0 <malloc+0x1600>
    3016:	1d6020ef          	jal	51ec <printf>
    exit(1);
    301a:	4505                	li	a0,1
    ...
    3026:	8be50513          	addi	a0,a0,-1858 # 68e0 <malloc+0x1640>
    302a:	1c2020ef          	jal	51ec <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303a:	8da50513          	addi	a0,a0,-1830 # 6910 <malloc+0x1670>
    303e:	1ae020ef          	jal	51ec <printf>
    exit(1);
    3042:	4505                	li	a0,1
    ...
    304e:	8e650513          	addi	a0,a0,-1818 # 6930 <malloc+0x1690>
    3052:	19a020ef          	jal	51ec <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3062:	8f250513          	addi	a0,a0,-1806 # 6950 <malloc+0x16b0>
    3066:	186020ef          	jal	51ec <printf>
    exit(1);
    306a:	4505                	li	a0,1
    ...
    3076:	8fe50513          	addi	a0,a0,-1794 # 6970 <malloc+0x16d0>
    307a:	172020ef          	jal	51ec <printf>
    exit(1);
    307e:	4505                	li	a0,1
    ...
    308a:	91a50513          	addi	a0,a0,-1766 # 69a0 <malloc+0x1700>
    308e:	15e020ef          	jal	51ec <printf>
    exit(1);
    3092:	4505                	li	a0,1
    ...
    309e:	92e50513          	addi	a0,a0,-1746 # 69c8 <malloc+0x1728>
    30a2:	14a020ef          	jal	51ec <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b2:	94250513          	addi	a0,a0,-1726 # 69f0 <malloc+0x1750>
    30b6:	136020ef          	jal	51ec <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    ...
    30c6:	95650513          	addi	a0,a0,-1706 # 6a18 <malloc+0x1778>
    30ca:	122020ef          	jal	51ec <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    ...
    30da:	96250513          	addi	a0,a0,-1694 # 6a38 <malloc+0x1798>
    30de:	10e020ef          	jal	51ec <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	96e50513          	addi	a0,a0,-1682 # 6a58 <malloc+0x17b8>
    30f2:	0fa020ef          	jal	51ec <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	98250513          	addi	a0,a0,-1662 # 6a80 <malloc+0x17e0>
    3106:	0e6020ef          	jal	51ec <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	98e50513          	addi	a0,a0,-1650 # 6aa0 <malloc+0x1800>
    311a:	0d2020ef          	jal	51ec <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	99a50513          	addi	a0,a0,-1638 # 6ac0 <malloc+0x1820>
    312e:	0be020ef          	jal	51ec <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	9ae50513          	addi	a0,a0,-1618 # 6ae8 <malloc+0x1848>
    3142:	0aa020ef          	jal	51ec <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	62a50513          	addi	a0,a0,1578 # 6778 <malloc+0x14d8>
    3156:	096020ef          	jal	51ec <printf>
    exit(1);
    315a:	4505                	li	a0,1
    ...
    3166:	9a650513          	addi	a0,a0,-1626 # 6b08 <malloc+0x1868>
    316a:	082020ef          	jal	51ec <printf>
    exit(1);
    316e:	4505                	li	a0,1
    ...
    317a:	9b250513          	addi	a0,a0,-1614 # 6b28 <malloc+0x1888>
    317e:	06e020ef          	jal	51ec <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    318e:	9ce50513          	addi	a0,a0,-1586 # 6b58 <malloc+0x18b8>
    3192:	05a020ef          	jal	51ec <printf>
    exit(1);
    3196:	4505                	li	a0,1
    ...
    31a2:	9da50513          	addi	a0,a0,-1574 # 6b78 <malloc+0x18d8>
    31a6:	046020ef          	jal	51ec <printf>
    exit(1);
    31aa:	4505                	li	a0,1
...
00000000000031b0 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    323c:	96050513          	addi	a0,a0,-1696 # 6b98 <malloc+0x18f8>
    3240:	7ad010ef          	jal	51ec <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	96450513          	addi	a0,a0,-1692 # 6bb0 <malloc+0x1910>
    3254:	799010ef          	jal	51ec <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	96850513          	addi	a0,a0,-1688 # 6bc8 <malloc+0x1928>
    3268:	785010ef          	jal	51ec <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	96c50513          	addi	a0,a0,-1684 # 6be0 <malloc+0x1940>
    327c:	771010ef          	jal	51ec <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	30850513          	addi	a0,a0,776 # 6590 <malloc+0x12f0>
    3290:	75d010ef          	jal	51ec <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	96450513          	addi	a0,a0,-1692 # 6c00 <malloc+0x1960>
    32a4:	749010ef          	jal	51ec <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	97850513          	addi	a0,a0,-1672 # 6c28 <malloc+0x1988>
    32b8:	735010ef          	jal	51ec <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	98450513          	addi	a0,a0,-1660 # 6c48 <malloc+0x19a8>
    32cc:	721010ef          	jal	51ec <printf>
    exit(1);
    32d0:	4505                	li	a0,1
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	98050513          	addi	a0,a0,-1664 # 6c68 <malloc+0x19c8>
  ...
  if(chdir("dirfile") == 0){
    ...
    3300:	96c50513          	addi	a0,a0,-1684 # 6c68 <malloc+0x19c8>
    3304:	2e1010ef          	jal	4de4 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	9a450513          	addi	a0,a0,-1628 # 6cb0 <malloc+0x1a10>
  ...
  fd = open(".", 0);
    ...
    3390:	73450513          	addi	a0,a0,1844 # 5ac0 <malloc+0x820>
    3394:	221010ef          	jal	4db4 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	0ac58593          	addi	a1,a1,172 # 5448 <malloc+0x1a8>
  ...
  close(fd);
    ...
    33c4:	8b050513          	addi	a0,a0,-1872 # 6c70 <malloc+0x19d0>
    33c8:	625010ef          	jal	51ec <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    ...
    33d8:	8bc50513          	addi	a0,a0,-1860 # 6c90 <malloc+0x19f0>
    33dc:	611010ef          	jal	51ec <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    ...
    33ec:	8d850513          	addi	a0,a0,-1832 # 6cc0 <malloc+0x1a20>
    33f0:	5fd010ef          	jal	51ec <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    ...
    3400:	8c450513          	addi	a0,a0,-1852 # 6cc0 <malloc+0x1a20>
    3404:	5e9010ef          	jal	51ec <printf>
    exit(1);
    3408:	4505                	li	a0,1
    ...
    3414:	8d850513          	addi	a0,a0,-1832 # 6ce8 <malloc+0x1a48>
    3418:	5d5010ef          	jal	51ec <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    3428:	8ec50513          	addi	a0,a0,-1812 # 6d10 <malloc+0x1a70>
    342c:	5c1010ef          	jal	51ec <printf>
    exit(1);
    3430:	4505                	li	a0,1
    ...
    343c:	90050513          	addi	a0,a0,-1792 # 6d38 <malloc+0x1a98>
    3440:	5ad010ef          	jal	51ec <printf>
    exit(1);
    3444:	4505                	li	a0,1
    ...
    3450:	91450513          	addi	a0,a0,-1772 # 6d60 <malloc+0x1ac0>
    3454:	599010ef          	jal	51ec <printf>
    exit(1);
    3458:	4505                	li	a0,1
    ...
    3464:	92050513          	addi	a0,a0,-1760 # 6d80 <malloc+0x1ae0>
    3468:	585010ef          	jal	51ec <printf>
    exit(1);
    346c:	4505                	li	a0,1
    ...
    3478:	93450513          	addi	a0,a0,-1740 # 6da8 <malloc+0x1b08>
    347c:	571010ef          	jal	51ec <printf>
    exit(1);
    3480:	4505                	li	a0,1
...
0000000000003486 <iref>:
{
    ...
    34a4:	920a0a13          	addi	s4,s4,-1760 # 6dc0 <malloc+0x1b20>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	42048493          	addi	s1,s1,1056 # 68c8 <malloc+0x1628>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	100a8a93          	addi	s5,s5,256 # 55b0 <malloc+0x310>
    fd = open("xx", O_CREATE);
    34b8:	00004997          	auipc	s3,0x4
    34bc:	80098993          	addi	s3,s3,-2048 # 6cb8 <malloc+0x1a18>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00004517          	auipc	a0,0x4
    34c8:	90450513          	addi	a0,a0,-1788 # 6dc8 <malloc+0x1b28>
    34cc:	521010ef          	jal	51ec <printf>
      exit(1);
    34d0:	4505                	li	a0,1
    ...
    34dc:	90850513          	addi	a0,a0,-1784 # 6de0 <malloc+0x1b40>
    34e0:	50d010ef          	jal	51ec <printf>
      exit(1);
    34e4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3544:	0a098993          	addi	s3,s3,160 # 65e0 <malloc+0x1340>
    unlink("irefd");
    3548:	00004917          	auipc	s2,0x4
    354c:	87890913          	addi	s2,s2,-1928 # 6dc0 <malloc+0x1b20>
    chdir("..");
    3550:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3564:	02850513          	addi	a0,a0,40 # 6588 <malloc+0x12e8>
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	86c50513          	addi	a0,a0,-1940 # 6df8 <malloc+0x1b58>
  ...
  if(pid == 0){
    ...
    35ac:	85050513          	addi	a0,a0,-1968 # 6df8 <malloc+0x1b58>
    ...
    35be:	85e50513          	addi	a0,a0,-1954 # 6e18 <malloc+0x1b78>
    35c2:	42b010ef          	jal	51ec <printf>
      exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d2:	83250513          	addi	a0,a0,-1998 # 6e00 <malloc+0x1b60>
    35d6:	417010ef          	jal	51ec <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35e6:	68650513          	addi	a0,a0,1670 # 5c68 <malloc+0x9c8>
    35ea:	403010ef          	jal	51ec <printf>
    exit(1);
    35ee:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3604:	7f850513          	addi	a0,a0,2040 # 6df8 <malloc+0x1b58>
    3608:	7bc010ef          	jal	4dc4 <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00003517          	auipc	a0,0x3
    3614:	84850513          	addi	a0,a0,-1976 # 5e58 <malloc+0xbb8>
    3618:	3d5010ef          	jal	51ec <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	80250513          	addi	a0,a0,-2046 # 6e40 <malloc+0x1ba0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3662:	7e250513          	addi	a0,a0,2018 # 6e40 <malloc+0x1ba0>
  ...
  pause(10); // one second
    ...
    368a:	7a250513          	addi	a0,a0,1954 # 5e28 <malloc+0xb88>
    368e:	35f010ef          	jal	51ec <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	6e0010ef          	jal	4d74 <exit>
      int fd = open("stopforking", 0);
    3698:	00003497          	auipc	s1,0x3
    369c:	7a848493          	addi	s1,s1,1960 # 6e40 <malloc+0x1ba0>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    ...
    36bc:	78850513          	addi	a0,a0,1928 # 6e40 <malloc+0x1ba0>
...
00000000000036d0 <killstatus>:
{
  ...
  exit(0);
    ...
    3722:	54a50513          	addi	a0,a0,1354 # 5c68 <malloc+0x9c8>
    3726:	2c7010ef          	jal	51ec <printf>
      exit(1);
    372a:	4505                	li	a0,1
    ...
    373c:	71850513          	addi	a0,a0,1816 # 6e50 <malloc+0x1bb0>
    3740:	2ad010ef          	jal	51ec <printf>
       exit(1);
    3744:	4505                	li	a0,1
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	6bc50513          	addi	a0,a0,1724 # 5e28 <malloc+0xb88>
    3774:	279010ef          	jal	51ec <printf>
    exit(1);
    3778:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3792:	4da50513          	addi	a0,a0,1242 # 5c68 <malloc+0x9c8>
    3796:	257010ef          	jal	51ec <printf>
    exit(1);
    379a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37c2:	c8a58593          	addi	a1,a1,-886 # 5448 <malloc+0x1a8>
    ...
    37e4:	48850513          	addi	a0,a0,1160 # 5c68 <malloc+0x9c8>
    37e8:	205010ef          	jal	51ec <printf>
     exit(1);
    37ec:	4505                	li	a0,1
    ...
    37f8:	67c50513          	addi	a0,a0,1660 # 6e70 <malloc+0x1bd0>
    37fc:	1f1010ef          	jal	51ec <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3828:	66450513          	addi	a0,a0,1636 # 6e88 <malloc+0x1be8>
    382c:	1c1010ef          	jal	51ec <printf>
}
  ...
  printf("kill... ");
    ...
    384c:	65850513          	addi	a0,a0,1624 # 6ea0 <malloc+0x1c00>
    3850:	19d010ef          	jal	51ec <printf>
  kill(pid1);
    3854:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    386a:	64a50513          	addi	a0,a0,1610 # 6eb0 <malloc+0x1c10>
    386e:	17f010ef          	jal	51ec <printf>
  wait(0);
    3872:	4501                	li	a0,0
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	3a250513          	addi	a0,a0,930 # 5c68 <malloc+0x9c8>
    38ce:	11f010ef          	jal	51ec <printf>
      exit(1);
    38d2:	4505                	li	a0,1
    ...
    38de:	51650513          	addi	a0,a0,1302 # 5df0 <malloc+0xb50>
    38e2:	10b010ef          	jal	51ec <printf>
        exit(1);
    38e6:	4505                	li	a0,1
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	43250513          	addi	a0,a0,1074 # 5d70 <malloc+0xad0>
    3946:	0a7010ef          	jal	51ec <printf>
    exit(1);
    394a:	4505                	li	a0,1
    ...
    396c:	cd058593          	addi	a1,a1,-816 # 7638 <malloc+0x2398>
    ...
    3988:	53c58593          	addi	a1,a1,1340 # 6ec0 <malloc+0x1c20>
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	4f250513          	addi	a0,a0,1266 # 6ec8 <malloc+0x1c28>
    39de:	00f010ef          	jal	51ec <printf>
  ...
  if(pid == 0){
    ...
    3a24:	4f850513          	addi	a0,a0,1272 # 6f18 <malloc+0x1c78>
    3a28:	7c4010ef          	jal	51ec <printf>
    exit(1);
    3a2c:	4505                	li	a0,1
    ...
    3a38:	4c450513          	addi	a0,a0,1220 # 6ef8 <malloc+0x1c58>
    3a3c:	7b0010ef          	jal	51ec <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a4c:	22050513          	addi	a0,a0,544 # 5c68 <malloc+0x9c8>
    3a50:	79c010ef          	jal	51ec <printf>
    exit(1);
    3a54:	4505                	li	a0,1
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ace:	6084                	ld	s1,0(s1)
      free(m1);
    3ad0:	74e010ef          	jal	521e <free>
    while(m1){
    3ad4:	fce5                	bnez	s1,3acc <mem+0x42>
    m1 = malloc(1024*20);
    3ad6:	6515                	lui	a0,0x5
    3ad8:	7c8010ef          	jal	52a0 <malloc>
    if(m1 == 0){
    3adc:	c511                	beqz	a0,3ae8 <mem+0x5e>
    free(m1);
    3ade:	740010ef          	jal	521e <free>
    exit(0);
    3ae2:	4501                	li	a0,0
    ...
    3aee:	45e50513          	addi	a0,a0,1118 # 6f48 <malloc+0x1ca8>
    3af2:	6fa010ef          	jal	51ec <printf>
      exit(1);
    3af6:	4505                	li	a0,1
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	45a50513          	addi	a0,a0,1114 # 6f68 <malloc+0x1cc8>
    3b16:	2ae010ef          	jal	4dc4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	44a50513          	addi	a0,a0,1098 # 6f68 <malloc+0x1cc8>
  ...
  if(pid == 0) {
    ...
    3b8c:	3f050513          	addi	a0,a0,1008 # 6f78 <malloc+0x1cd8>
    3b90:	65c010ef          	jal	51ec <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba0:	40450513          	addi	a0,a0,1028 # 6fa0 <malloc+0x1d00>
    3ba4:	648010ef          	jal	51ec <printf>
      exit(1);
    3ba8:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bd0:	39c50513          	addi	a0,a0,924 # 6f68 <malloc+0x1cc8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	3bc50513          	addi	a0,a0,956 # 6fc0 <malloc+0x1d20>
    3c0c:	5e0010ef          	jal	51ec <printf>
    exit(1);
    3c10:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c38:	33450513          	addi	a0,a0,820 # 6f68 <malloc+0x1cc8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	39250513          	addi	a0,a0,914 # 6fe8 <malloc+0x1d48>
    3c5e:	58e010ef          	jal	51ec <printf>
    exit(1);
    3c62:	4505                	li	a0,1
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	37278793          	addi	a5,a5,882 # 7000 <malloc+0x1d60>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	36e78793          	addi	a5,a5,878 # 7008 <malloc+0x1d68>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	36a78793          	addi	a5,a5,874 # 7010 <malloc+0x1d70>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	36678793          	addi	a5,a5,870 # 7018 <malloc+0x1d78>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	f5450513          	addi	a0,a0,-172 # 5c68 <malloc+0x9c8>
    3d1c:	4d0010ef          	jal	51ec <printf>
      exit(1);
    3d20:	4505                	li	a0,1
    ...
    3d7a:	f8a50513          	addi	a0,a0,-118 # 5d00 <malloc+0xa60>
    3d7e:	46e010ef          	jal	51ec <printf>
        exit(1);
    3d82:	4505                	li	a0,1
    3d84:	7f1000ef          	jal	4d74 <exit>
          printf("write failed %d\n", n);
    3d88:	00003517          	auipc	a0,0x3
    3d8c:	29850513          	addi	a0,a0,664 # 7020 <malloc+0x1d80>
    3d90:	45c010ef          	jal	51ec <printf>
          exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da6:	29650513          	addi	a0,a0,662 # 7038 <malloc+0x1d98>
    3daa:	442010ef          	jal	51ec <printf>
          exit(1);
    3dae:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	23650513          	addi	a0,a0,566 # 7048 <malloc+0x1da8>
    3e1a:	3d2010ef          	jal	51ec <printf>
      exit(1);
    3e1e:	4505                	li	a0,1
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	1f4b8b93          	addi	s7,s7,500 # 7060 <malloc+0x1dc0>
  for(i = 0; i < N; i++){
    ...
    3eaa:	1c250513          	addi	a0,a0,450 # 7068 <malloc+0x1dc8>
    3eae:	33e010ef          	jal	51ec <printf>
        exit(1);
    3eb2:	4505                	li	a0,1
    ...
    3ec0:	1a450513          	addi	a0,a0,420 # 7060 <malloc+0x1dc0>
  ...
  fd = open(".", 0);
    ...
    3ee8:	bdc50513          	addi	a0,a0,-1060 # 5ac0 <malloc+0x820>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	13450513          	addi	a0,a0,308 # 7088 <malloc+0x1de8>
    3f5c:	290010ef          	jal	51ec <printf>
        exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f70:	13c50513          	addi	a0,a0,316 # 70a8 <malloc+0x1e08>
    3f74:	278010ef          	jal	51ec <printf>
        exit(1);
    3f78:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	13850513          	addi	a0,a0,312 # 70d0 <malloc+0x1e30>
    3fa0:	24c010ef          	jal	51ec <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb0:	cbc50513          	addi	a0,a0,-836 # 5c68 <malloc+0x9c8>
    3fb4:	238010ef          	jal	51ec <printf>
      exit(1);
    3fb8:	4505                	li	a0,1
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	00e50513          	addi	a0,a0,14 # 7108 <malloc+0x1e68>
    4102:	4c3000ef          	jal	4dc4 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	ffe50513          	addi	a0,a0,-2 # 7108 <malloc+0x1e68>
  ...
  fd = open("bigfile.dat", 0);
    ...
    415a:	fb250513          	addi	a0,a0,-78 # 7108 <malloc+0x1e68>
  ...
  for(i = 0; ; i++){
    ...
    41b6:	f6650513          	addi	a0,a0,-154 # 7118 <malloc+0x1e78>
    41ba:	032010ef          	jal	51ec <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ca:	f7250513          	addi	a0,a0,-142 # 7138 <malloc+0x1e98>
    41ce:	01e010ef          	jal	51ec <printf>
      exit(1);
    41d2:	4505                	li	a0,1
    ...
    41de:	f7e50513          	addi	a0,a0,-130 # 7158 <malloc+0x1eb8>
    41e2:	00a010ef          	jal	51ec <printf>
    exit(1);
    41e6:	4505                	li	a0,1
    ...
    41f2:	f8a50513          	addi	a0,a0,-118 # 7178 <malloc+0x1ed8>
    41f6:	7f7000ef          	jal	51ec <printf>
      exit(1);
    41fa:	4505                	li	a0,1
    ...
    4206:	f9650513          	addi	a0,a0,-106 # 7198 <malloc+0x1ef8>
    420a:	7e3000ef          	jal	51ec <printf>
      exit(1);
    420e:	4505                	li	a0,1
    ...
    421a:	f9a50513          	addi	a0,a0,-102 # 71b0 <malloc+0x1f10>
    421e:	7cf000ef          	jal	51ec <printf>
      exit(1);
    4222:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    423c:	ed050513          	addi	a0,a0,-304 # 7108 <malloc+0x1e68>
    ...
    425c:	f7850513          	addi	a0,a0,-136 # 71d0 <malloc+0x1f30>
    4260:	78d000ef          	jal	51ec <printf>
    exit(1);
    4264:	4505                	li	a0,1
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	f7a50513          	addi	a0,a0,-134 # 71f0 <malloc+0x1f50>
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	f5450513          	addi	a0,a0,-172 # 71f0 <malloc+0x1f50>
  ...
  close(fd);
    ...
    42fa:	0e250513          	addi	a0,a0,226 # 53d8 <malloc+0x138>
    42fe:	2af000ef          	jal	4dac <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	eea50513          	addi	a0,a0,-278 # 71f0 <malloc+0x1f50>
    ...
    4322:	ee250513          	addi	a0,a0,-286 # 7200 <malloc+0x1f60>
    4326:	6c7000ef          	jal	51ec <printf>
    exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	eea50513          	addi	a0,a0,-278 # 7220 <malloc+0x1f80>
    433e:	6af000ef          	jal	51ec <printf>
    exit(1);
    4342:	4505                	li	a0,1
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	eb250513          	addi	a0,a0,-334 # 7240 <malloc+0x1fa0>
    4396:	657000ef          	jal	51ec <printf>
    exit(1);
    439a:	4505                	li	a0,1
    439c:	1d9000ef          	jal	4d74 <exit>
      printf("failed to read value from memory\n");
    43a0:	00003517          	auipc	a0,0x3
    43a4:	eb850513          	addi	a0,a0,-328 # 7258 <malloc+0x1fb8>
    43a8:	645000ef          	jal	51ec <printf>
      exit(1);
    43ac:	4505                	li	a0,1
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	e2a50513          	addi	a0,a0,-470 # 7240 <malloc+0x1fa0>
    441e:	5cf000ef          	jal	51ec <printf>
    exit(1);
    4422:	4505                	li	a0,1
    4424:	151000ef          	jal	4d74 <exit>
      printf("error forking\n");
    4428:	00003517          	auipc	a0,0x3
    442c:	e5850513          	addi	a0,a0,-424 # 7280 <malloc+0x1fe0>
    4430:	5bd000ef          	jal	51ec <printf>
      exit(1);
    4434:	4505                	li	a0,1
    ...
    4450:	e4450513          	addi	a0,a0,-444 # 7290 <malloc+0x1ff0>
    4454:	599000ef          	jal	51ec <printf>
        exit(1);
    4458:	4505                	li	a0,1
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	e0650513          	addi	a0,a0,-506 # 72a8 <malloc+0x2008>
    44aa:	543000ef          	jal	51ec <printf>
      exit(1);
    44ae:	4505                	li	a0,1
    44b0:	0c5000ef          	jal	4d74 <exit>
  unsigned long bad[] = {
    44b4:	00003797          	auipc	a5,0x3
    44b8:	46c78793          	addi	a5,a5,1132 # 7920 <malloc+0x2680>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	0c8a0a13          	addi	s4,s4,200 # 55b0 <malloc+0x310>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	fd0a8a93          	addi	s5,s5,-48 # 54c0 <malloc+0x220>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
  ...
  exit(0);
    ...
    4552:	d8a50513          	addi	a0,a0,-630 # 72d8 <malloc+0x2038>
    4556:	497000ef          	jal	51ec <printf>
    455a:	4505                	li	a0,1
    455c:	019000ef          	jal	4d74 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4560:	00003517          	auipc	a0,0x3
    4564:	d9050513          	addi	a0,a0,-624 # 72f0 <malloc+0x2050>
    4568:	485000ef          	jal	51ec <printf>
    456c:	4505                	li	a0,1
    456e:	007000ef          	jal	4d74 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4572:	00003517          	auipc	a0,0x3
    4576:	d8e50513          	addi	a0,a0,-626 # 7300 <malloc+0x2060>
    457a:	473000ef          	jal	51ec <printf>
    457e:	4505                	li	a0,1
    4580:	7f4000ef          	jal	4d74 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4584:	00003517          	auipc	a0,0x3
    4588:	d9450513          	addi	a0,a0,-620 # 7318 <malloc+0x2078>
    458c:	461000ef          	jal	51ec <printf>
    4590:	4505                	li	a0,1
...
0000000000004596 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    45e4:	d5050513          	addi	a0,a0,-688 # 7330 <malloc+0x2090>
    45e8:	405000ef          	jal	51ec <printf>
    exit(1);
    45ec:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    460c:	d5850513          	addi	a0,a0,-680 # 7360 <malloc+0x20c0>
    4610:	3dd000ef          	jal	51ec <printf>
    exit(1);
    4614:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    4632:	d6a50513          	addi	a0,a0,-662 # 7398 <malloc+0x20f8>
    4636:	3b7000ef          	jal	51ec <printf>
    exit(1);
    463a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4652:	d7250513          	addi	a0,a0,-654 # 73c0 <malloc+0x2120>
    4656:	397000ef          	jal	51ec <printf>
    exit(1);
    465a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4672:	d7a50513          	addi	a0,a0,-646 # 73e8 <malloc+0x2148>
    4676:	377000ef          	jal	51ec <printf>
    exit(1);
    467a:	4505                	li	a0,1
...
0000000000004686 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    46a6:	d7650513          	addi	a0,a0,-650 # 7418 <malloc+0x2178>
    46aa:	343000ef          	jal	51ec <printf>
  for(nfiles = 0; ; nfiles++){
    46ae:	4481                	li	s1,0
    name[0] = 'f';
    ...
    46c2:	d6ac8c93          	addi	s9,s9,-662 # 7428 <malloc+0x2188>
    name[0] = 'f';
    ...
    472a:	d1250513          	addi	a0,a0,-750 # 7438 <malloc+0x2198>
    472e:	2bf000ef          	jal	51ec <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4798:	cc450513          	addi	a0,a0,-828 # 7458 <malloc+0x21b8>
    479c:	251000ef          	jal	51ec <printf>
}
    ...
    47e6:	c6650513          	addi	a0,a0,-922 # 7448 <malloc+0x21a8>
    47ea:	203000ef          	jal	51ec <printf>
    close(fd);
    47ee:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4810:	c6450513          	addi	a0,a0,-924 # 7470 <malloc+0x21d0>
    4814:	1d9000ef          	jal	51ec <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4834:	c6850513          	addi	a0,a0,-920 # 7498 <malloc+0x21f8>
    4838:	1b5000ef          	jal	51ec <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4854:	c3050513          	addi	a0,a0,-976 # 7480 <malloc+0x21e0>
    4858:	195000ef          	jal	51ec <printf>
    exit(1);
    485c:	4505                	li	a0,1
    ...
    4870:	c3450513          	addi	a0,a0,-972 # 74a0 <malloc+0x2200>
    4874:	179000ef          	jal	51ec <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    48c2:	bea50513          	addi	a0,a0,-1046 # 74a8 <malloc+0x2208>
    48c6:	127000ef          	jal	51ec <printf>
          return -1;
    48ca:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    495a:	b6ac0c13          	addi	s8,s8,-1174 # 74c0 <malloc+0x2220>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4974:	b68d8d93          	addi	s11,s11,-1176 # 74d8 <malloc+0x2238>
      } else {
        ntests += n;
      }
    }
    ...
    497c:	b80d0d13          	addi	s10,s10,-1152 # 74f8 <malloc+0x2258>
    ...
    49f6:	b3650513          	addi	a0,a0,-1226 # 7528 <malloc+0x2288>
    49fa:	7f2000ef          	jal	51ec <printf>
      return 1;
    49fe:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4a60:	ae458593          	addi	a1,a1,-1308 # 7540 <malloc+0x22a0>
  ...
  int continuous = 0;
    ...
    4ab4:	aa050513          	addi	a0,a0,-1376 # 7550 <malloc+0x22b0>
    4ab8:	734000ef          	jal	51ec <printf>
    exit(1);
    4abc:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4ad2:	ab250513          	addi	a0,a0,-1358 # 7580 <malloc+0x22e0>
    4ad6:	716000ef          	jal	51ec <printf>
  exit(0);
    4ada:	4501                	li	a0,0
...
0000000000004e3c <set_pid_namespace>:
...
0000000000004e44 <get_pid_namespace>:
...
putc(int fd, char c)
{
    4e64:	1101                	addi	sp,sp,-32
    4e66:	ec06                	sd	ra,24(sp)
    4e68:	e822                	sd	s0,16(sp)
    4e6a:	1000                	addi	s0,sp,32
    4e6c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4e70:	4605                	li	a2,1
    4e72:	fef40593          	addi	a1,s0,-17
    4e76:	f1fff0ef          	jal	4d94 <write>
}
    4e7a:	60e2                	ld	ra,24(sp)
    4e7c:	6442                	ld	s0,16(sp)
    4e7e:	6105                	addi	sp,sp,32
    4e80:	8082                	ret

0000000000004e82 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4e82:	715d                	addi	sp,sp,-80
    4e84:	e486                	sd	ra,72(sp)
    4e86:	e0a2                	sd	s0,64(sp)
    4e88:	f84a                	sd	s2,48(sp)
    4e8a:	0880                	addi	s0,sp,80
    4e8c:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4e8e:	c299                	beqz	a3,4e94 <printint+0x12>
    4e90:	0805c363          	bltz	a1,4f16 <printint+0x94>
  neg = 0;
    4e94:	4881                	li	a7,0
    4e96:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    ...
    4ea0:	b2c50513          	addi	a0,a0,-1236 # 79c8 <digits>
    4ea4:	883e                	mv	a6,a5
    4ea6:	2785                	addiw	a5,a5,1
    4ea8:	02c5f733          	remu	a4,a1,a2
    4eac:	972a                	add	a4,a4,a0
    4eae:	00074703          	lbu	a4,0(a4)
    4eb2:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4eb6:	872e                	mv	a4,a1
    4eb8:	02c5d5b3          	divu	a1,a1,a2
    4ebc:	0685                	addi	a3,a3,1
    4ebe:	fec773e3          	bgeu	a4,a2,4ea4 <printint+0x22>
  if(neg)
    4ec2:	00088b63          	beqz	a7,4ed8 <printint+0x56>
    buf[i++] = '-';
    4ec6:	fd078793          	addi	a5,a5,-48
    4eca:	97a2                	add	a5,a5,s0
    4ecc:	02d00713          	li	a4,45
    4ed0:	fee78423          	sb	a4,-24(a5)
    4ed4:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    4ed8:	02f05a63          	blez	a5,4f0c <printint+0x8a>
    4edc:	fc26                	sd	s1,56(sp)
    4ede:	f44e                	sd	s3,40(sp)
    4ee0:	fb840713          	addi	a4,s0,-72
    4ee4:	00f704b3          	add	s1,a4,a5
    4ee8:	fff70993          	addi	s3,a4,-1
    4eec:	99be                	add	s3,s3,a5
    4eee:	37fd                	addiw	a5,a5,-1
    4ef0:	1782                	slli	a5,a5,0x20
    4ef2:	9381                	srli	a5,a5,0x20
    4ef4:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
    4ef8:	fff4c583          	lbu	a1,-1(s1)
    4efc:	854a                	mv	a0,s2
    4efe:	f67ff0ef          	jal	4e64 <putc>
  while(--i >= 0)
    4f02:	14fd                	addi	s1,s1,-1
    4f04:	ff349ae3          	bne	s1,s3,4ef8 <printint+0x76>
    4f08:	74e2                	ld	s1,56(sp)
    4f0a:	79a2                	ld	s3,40(sp)
}
    4f0c:	60a6                	ld	ra,72(sp)
    4f0e:	6406                	ld	s0,64(sp)
    4f10:	7942                	ld	s2,48(sp)
    4f12:	6161                	addi	sp,sp,80
    4f14:	8082                	ret
    x = -xx;
    4f16:	40b005b3          	neg	a1,a1
    neg = 1;
    4f1a:	4885                	li	a7,1
    x = -xx;
    4f1c:	bfad                	j	4e96 <printint+0x14>

0000000000004f1e <vprintf>:
}
...
{
    4f1e:	711d                	addi	sp,sp,-96
    4f20:	ec86                	sd	ra,88(sp)
    4f22:	e8a2                	sd	s0,80(sp)
    4f24:	e0ca                	sd	s2,64(sp)
    4f26:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4f28:	0005c903          	lbu	s2,0(a1)
    4f2c:	28090663          	beqz	s2,51b8 <vprintf+0x29a>
    4f30:	e4a6                	sd	s1,72(sp)
    4f32:	fc4e                	sd	s3,56(sp)
    4f34:	f852                	sd	s4,48(sp)
    4f36:	f456                	sd	s5,40(sp)
    4f38:	f05a                	sd	s6,32(sp)
    4f3a:	ec5e                	sd	s7,24(sp)
    4f3c:	e862                	sd	s8,16(sp)
    4f3e:	e466                	sd	s9,8(sp)
    4f40:	8b2a                	mv	s6,a0
    4f42:	8a2e                	mv	s4,a1
    4f44:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4f4c:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4f50:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4f54:	06c00c93          	li	s9,108
    4f58:	a005                	j	4f78 <vprintf+0x5a>
        putc(fd, c0);
    4f5a:	85ca                	mv	a1,s2
    4f5c:	855a                	mv	a0,s6
    4f5e:	f07ff0ef          	jal	4e64 <putc>
    4f62:	a019                	j	4f68 <vprintf+0x4a>
    } else if(state == '%'){
    4f64:	03598263          	beq	s3,s5,4f88 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4f68:	2485                	addiw	s1,s1,1
    4f6a:	8726                	mv	a4,s1
    4f6c:	009a07b3          	add	a5,s4,s1
    4f70:	0007c903          	lbu	s2,0(a5)
    4f74:	22090a63          	beqz	s2,51a8 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    4f78:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4f7c:	fe0994e3          	bnez	s3,4f64 <vprintf+0x46>
      if(c0 == '%'){
    4f80:	fd579de3          	bne	a5,s5,4f5a <vprintf+0x3c>
        state = '%';
    4f84:	89be                	mv	s3,a5
    4f86:	b7cd                	j	4f68 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4f88:	00ea06b3          	add	a3,s4,a4
    4f8c:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4f90:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4f92:	c681                	beqz	a3,4f9a <vprintf+0x7c>
    4f94:	9752                	add	a4,a4,s4
    4f96:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4f9a:	05878363          	beq	a5,s8,4fe0 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4f9e:	05978d63          	beq	a5,s9,4ff8 <vprintf+0xda>
    ...
    4fa2:	07500713          	li	a4,117
    4fa6:	0ee78763          	beq	a5,a4,5094 <vprintf+0x176>
    ...
    4faa:	07800713          	li	a4,120
    4fae:	12e78963          	beq	a5,a4,50e0 <vprintf+0x1c2>
    ...
    4fb2:	07000713          	li	a4,112
    4fb6:	14e78e63          	beq	a5,a4,5112 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4fba:	06300713          	li	a4,99
    4fbe:	18e78e63          	beq	a5,a4,515a <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4fc2:	07300713          	li	a4,115
    4fc6:	1ae78463          	beq	a5,a4,516e <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4fca:	02500713          	li	a4,37
    4fce:	04e79563          	bne	a5,a4,5018 <vprintf+0xfa>
        putc(fd, '%');
    4fd2:	02500593          	li	a1,37
    4fd6:	855a                	mv	a0,s6
    4fd8:	e8dff0ef          	jal	4e64 <putc>
      ...
      state = 0;
    4fdc:	4981                	li	s3,0
    4fde:	b769                	j	4f68 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4fe0:	008b8913          	addi	s2,s7,8
    4fe4:	4685                	li	a3,1
    4fe6:	4629                	li	a2,10
    4fe8:	000ba583          	lw	a1,0(s7)
    4fec:	855a                	mv	a0,s6
    4fee:	e95ff0ef          	jal	4e82 <printint>
    4ff2:	8bca                	mv	s7,s2
      state = 0;
    4ff4:	4981                	li	s3,0
    4ff6:	bf8d                	j	4f68 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4ff8:	06400793          	li	a5,100
    4ffc:	02f68963          	beq	a3,a5,502e <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    5000:	06c00793          	li	a5,108
    5004:	04f68263          	beq	a3,a5,5048 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    5008:	07500793          	li	a5,117
    500c:	0af68063          	beq	a3,a5,50ac <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    5010:	07800793          	li	a5,120
    5014:	0ef68263          	beq	a3,a5,50f8 <vprintf+0x1da>
        putc(fd, '%');
    5018:	02500593          	li	a1,37
    501c:	855a                	mv	a0,s6
    501e:	e47ff0ef          	jal	4e64 <putc>
        putc(fd, c0);
    5022:	85ca                	mv	a1,s2
    5024:	855a                	mv	a0,s6
    5026:	e3fff0ef          	jal	4e64 <putc>
      state = 0;
    502a:	4981                	li	s3,0
    502c:	bf35                	j	4f68 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    502e:	008b8913          	addi	s2,s7,8
    5032:	4685                	li	a3,1
    5034:	4629                	li	a2,10
    5036:	000bb583          	ld	a1,0(s7)
    503a:	855a                	mv	a0,s6
    503c:	e47ff0ef          	jal	4e82 <printint>
        i += 1;
    5040:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 1);
    5042:	8bca                	mv	s7,s2
      state = 0;
    5044:	4981                	li	s3,0
        i += 1;
    5046:	b70d                	j	4f68 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    5048:	06400793          	li	a5,100
    504c:	02f60763          	beq	a2,a5,507a <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    5050:	07500793          	li	a5,117
    5054:	06f60963          	beq	a2,a5,50c6 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    5058:	07800793          	li	a5,120
    505c:	faf61ee3          	bne	a2,a5,5018 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    506c:	855a                	mv	a0,s6
    506e:	e15ff0ef          	jal	4e82 <printint>
        i += 2;
    5072:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    5074:	8bca                	mv	s7,s2
      state = 0;
    5076:	4981                	li	s3,0
        i += 2;
    5078:	bdc5                	j	4f68 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    507a:	008b8913          	addi	s2,s7,8
    507e:	4685                	li	a3,1
    5080:	4629                	li	a2,10
    5082:	000bb583          	ld	a1,0(s7)
    5086:	855a                	mv	a0,s6
    5088:	dfbff0ef          	jal	4e82 <printint>
        i += 2;
    508c:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    508e:	8bca                	mv	s7,s2
      state = 0;
    5090:	4981                	li	s3,0
        i += 2;
    5092:	bdd9                	j	4f68 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    5094:	008b8913          	addi	s2,s7,8
    5098:	4681                	li	a3,0
    509a:	4629                	li	a2,10
    509c:	000be583          	lwu	a1,0(s7)
    50a0:	855a                	mv	a0,s6
    50a2:	de1ff0ef          	jal	4e82 <printint>
    50a6:	8bca                	mv	s7,s2
      state = 0;
    50a8:	4981                	li	s3,0
    50aa:	bd7d                	j	4f68 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    50b8:	855a                	mv	a0,s6
    50ba:	dc9ff0ef          	jal	4e82 <printint>
        i += 1;
    ...
    50c2:	4981                	li	s3,0
        i += 1;
    50c4:	b555                	j	4f68 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    50c6:	008b8913          	addi	s2,s7,8
    50ca:	4681                	li	a3,0
    50cc:	4629                	li	a2,10
    50ce:	000bb583          	ld	a1,0(s7)
    50d2:	855a                	mv	a0,s6
    50d4:	dafff0ef          	jal	4e82 <printint>
        i += 2;
    50d8:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    50da:	8bca                	mv	s7,s2
      state = 0;
    50dc:	4981                	li	s3,0
        i += 2;
    50de:	b569                	j	4f68 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    50e0:	008b8913          	addi	s2,s7,8
    50e4:	4681                	li	a3,0
    50e6:	4641                	li	a2,16
    50e8:	000be583          	lwu	a1,0(s7)
    50ec:	855a                	mv	a0,s6
    50ee:	d95ff0ef          	jal	4e82 <printint>
    50f2:	8bca                	mv	s7,s2
      state = 0;
    50f4:	4981                	li	s3,0
    50f6:	bd8d                	j	4f68 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    ...
    5104:	855a                	mv	a0,s6
    5106:	d7dff0ef          	jal	4e82 <printint>
        i += 1;
    510a:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
    510c:	8bca                	mv	s7,s2
      state = 0;
    510e:	4981                	li	s3,0
        i += 1;
    5110:	bda1                	j	4f68 <vprintf+0x4a>
    5112:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    5114:	008b8d13          	addi	s10,s7,8
    5118:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    511c:	03000593          	li	a1,48
    5120:	855a                	mv	a0,s6
    5122:	d43ff0ef          	jal	4e64 <putc>
  putc(fd, 'x');
    5126:	07800593          	li	a1,120
    512a:	855a                	mv	a0,s6
    512c:	d39ff0ef          	jal	4e64 <putc>
    5130:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5132:	00003b97          	auipc	s7,0x3
    5136:	896b8b93          	addi	s7,s7,-1898 # 79c8 <digits>
    513a:	03c9d793          	srli	a5,s3,0x3c
    513e:	97de                	add	a5,a5,s7
    5140:	0007c583          	lbu	a1,0(a5)
    5144:	855a                	mv	a0,s6
    5146:	d1fff0ef          	jal	4e64 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    514a:	0992                	slli	s3,s3,0x4
    514c:	397d                	addiw	s2,s2,-1
    514e:	fe0916e3          	bnez	s2,513a <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    5152:	8bea                	mv	s7,s10
      state = 0;
    5154:	4981                	li	s3,0
    5156:	6d02                	ld	s10,0(sp)
    5158:	bd01                	j	4f68 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    515a:	008b8913          	addi	s2,s7,8
    515e:	000bc583          	lbu	a1,0(s7)
    5162:	855a                	mv	a0,s6
    5164:	d01ff0ef          	jal	4e64 <putc>
    5168:	8bca                	mv	s7,s2
      state = 0;
    516a:	4981                	li	s3,0
    516c:	bbf5                	j	4f68 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    516e:	008b8993          	addi	s3,s7,8
    5172:	000bb903          	ld	s2,0(s7)
    5176:	00090f63          	beqz	s2,5194 <vprintf+0x276>
        for(; *s; s++)
    517a:	00094583          	lbu	a1,0(s2)
    517e:	c195                	beqz	a1,51a2 <vprintf+0x284>
          putc(fd, *s);
    5180:	855a                	mv	a0,s6
    5182:	ce3ff0ef          	jal	4e64 <putc>
        for(; *s; s++)
    5186:	0905                	addi	s2,s2,1
    5188:	00094583          	lbu	a1,0(s2)
    518c:	f9f5                	bnez	a1,5180 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    518e:	8bce                	mv	s7,s3
      state = 0;
    5190:	4981                	li	s3,0
    5192:	bbd9                	j	4f68 <vprintf+0x4a>
          s = "(null)";
    5194:	00002917          	auipc	s2,0x2
    5198:	78490913          	addi	s2,s2,1924 # 7918 <malloc+0x2678>
        for(; *s; s++)
    519c:	02800593          	li	a1,40
    51a0:	b7c5                	j	5180 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    51a2:	8bce                	mv	s7,s3
      state = 0;
    51a4:	4981                	li	s3,0
    51a6:	b3c9                	j	4f68 <vprintf+0x4a>
    51a8:	64a6                	ld	s1,72(sp)
    51aa:	79e2                	ld	s3,56(sp)
    51ac:	7a42                	ld	s4,48(sp)
    51ae:	7aa2                	ld	s5,40(sp)
    51b0:	7b02                	ld	s6,32(sp)
    51b2:	6be2                	ld	s7,24(sp)
    51b4:	6c42                	ld	s8,16(sp)
    51b6:	6ca2                	ld	s9,8(sp)
    }
  }
}
    51b8:	60e6                	ld	ra,88(sp)
    51ba:	6446                	ld	s0,80(sp)
    51bc:	6906                	ld	s2,64(sp)
    51be:	6125                	addi	sp,sp,96
    51c0:	8082                	ret

00000000000051c2 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    51c2:	715d                	addi	sp,sp,-80
    51c4:	ec06                	sd	ra,24(sp)
    51c6:	e822                	sd	s0,16(sp)
    51c8:	1000                	addi	s0,sp,32
    51ca:	e010                	sd	a2,0(s0)
    51cc:	e414                	sd	a3,8(s0)
    51ce:	e818                	sd	a4,16(s0)
    51d0:	ec1c                	sd	a5,24(s0)
    51d2:	03043023          	sd	a6,32(s0)
    51d6:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    51da:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    51de:	8622                	mv	a2,s0
    51e0:	d3fff0ef          	jal	4f1e <vprintf>
}
    51e4:	60e2                	ld	ra,24(sp)
    51e6:	6442                	ld	s0,16(sp)
    51e8:	6161                	addi	sp,sp,80
    51ea:	8082                	ret

00000000000051ec <printf>:

void
printf(const char *fmt, ...)
{
    51ec:	711d                	addi	sp,sp,-96
    51ee:	ec06                	sd	ra,24(sp)
    51f0:	e822                	sd	s0,16(sp)
    51f2:	1000                	addi	s0,sp,32
    51f4:	e40c                	sd	a1,8(s0)
    51f6:	e810                	sd	a2,16(s0)
    51f8:	ec14                	sd	a3,24(s0)
    51fa:	f018                	sd	a4,32(s0)
    51fc:	f41c                	sd	a5,40(s0)
    51fe:	03043823          	sd	a6,48(s0)
    5202:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5206:	00840613          	addi	a2,s0,8
    520a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    520e:	85aa                	mv	a1,a0
    5210:	4505                	li	a0,1
    5212:	d0dff0ef          	jal	4f1e <vprintf>
}
    5216:	60e2                	ld	ra,24(sp)
    5218:	6442                	ld	s0,16(sp)
    521a:	6125                	addi	sp,sp,96
    521c:	8082                	ret

000000000000521e <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    521e:	1141                	addi	sp,sp,-16
    5220:	e422                	sd	s0,8(sp)
    5222:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5224:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5228:	00003797          	auipc	a5,0x3
    522c:	2687b783          	ld	a5,616(a5) # 8490 <freep>
    5230:	a02d                	j	525a <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5232:	4618                	lw	a4,8(a2)
    5234:	9f2d                	addw	a4,a4,a1
    5236:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    523a:	6398                	ld	a4,0(a5)
    523c:	6310                	ld	a2,0(a4)
    523e:	a83d                	j	527c <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5240:	ff852703          	lw	a4,-8(a0)
    5244:	9f31                	addw	a4,a4,a2
    5246:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5248:	ff053683          	ld	a3,-16(a0)
    524c:	a091                	j	5290 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    524e:	6398                	ld	a4,0(a5)
    5250:	00e7e463          	bltu	a5,a4,5258 <free+0x3a>
    5254:	00e6ea63          	bltu	a3,a4,5268 <free+0x4a>
{
    5258:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    525a:	fed7fae3          	bgeu	a5,a3,524e <free+0x30>
    525e:	6398                	ld	a4,0(a5)
    5260:	00e6e463          	bltu	a3,a4,5268 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5264:	fee7eae3          	bltu	a5,a4,5258 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5268:	ff852583          	lw	a1,-8(a0)
    526c:	6390                	ld	a2,0(a5)
    526e:	02059813          	slli	a6,a1,0x20
    5272:	01c85713          	srli	a4,a6,0x1c
    5276:	9736                	add	a4,a4,a3
    5278:	fae60de3          	beq	a2,a4,5232 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    527c:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5280:	4790                	lw	a2,8(a5)
    5282:	02061593          	slli	a1,a2,0x20
    5286:	01c5d713          	srli	a4,a1,0x1c
    528a:	973e                	add	a4,a4,a5
    528c:	fae68ae3          	beq	a3,a4,5240 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5290:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5292:	00003717          	auipc	a4,0x3
    5296:	1ef73f23          	sd	a5,510(a4) # 8490 <freep>
}
    529a:	6422                	ld	s0,8(sp)
    529c:	0141                	addi	sp,sp,16
    529e:	8082                	ret

00000000000052a0 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    52a0:	7139                	addi	sp,sp,-64
    52a2:	fc06                	sd	ra,56(sp)
    52a4:	f822                	sd	s0,48(sp)
    52a6:	f426                	sd	s1,40(sp)
    52a8:	ec4e                	sd	s3,24(sp)
    52aa:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    52ac:	02051493          	slli	s1,a0,0x20
    52b0:	9081                	srli	s1,s1,0x20
    52b2:	04bd                	addi	s1,s1,15
    52b4:	8091                	srli	s1,s1,0x4
    52b6:	0014899b          	addiw	s3,s1,1
    52ba:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    52bc:	00003517          	auipc	a0,0x3
    52c0:	1d453503          	ld	a0,468(a0) # 8490 <freep>
    52c4:	c915                	beqz	a0,52f8 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    52ca:	08977a63          	bgeu	a4,s1,535e <malloc+0xbe>
    52ce:	f04a                	sd	s2,32(sp)
    52d0:	e852                	sd	s4,16(sp)
    52d2:	e456                	sd	s5,8(sp)
    52d4:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    52d6:	8a4e                	mv	s4,s3
    52d8:	0009871b          	sext.w	a4,s3
    52dc:	6685                	lui	a3,0x1
    52de:	00d77363          	bgeu	a4,a3,52e4 <malloc+0x44>
    52e2:	6a05                	lui	s4,0x1
    52e4:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    52e8:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    52ec:	00003917          	auipc	s2,0x3
    52f0:	1a490913          	addi	s2,s2,420 # 8490 <freep>
  if(p == SBRK_ERROR)
    52f4:	5afd                	li	s5,-1
    52f6:	a081                	j	5336 <malloc+0x96>
    52f8:	f04a                	sd	s2,32(sp)
    52fa:	e852                	sd	s4,16(sp)
    52fc:	e456                	sd	s5,8(sp)
    52fe:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    5300:	0000a797          	auipc	a5,0xa
    5304:	9b878793          	addi	a5,a5,-1608 # ecb8 <base>
    5308:	00003717          	auipc	a4,0x3
    530c:	18f73423          	sd	a5,392(a4) # 8490 <freep>
    5310:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5312:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5316:	b7c1                	j	52d6 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    5318:	6398                	ld	a4,0(a5)
    531a:	e118                	sd	a4,0(a0)
    531c:	a8a9                	j	5376 <malloc+0xd6>
  hp->s.size = nu;
    531e:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5322:	0541                	addi	a0,a0,16
    5324:	efbff0ef          	jal	521e <free>
  return freep;
    5328:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    532c:	c12d                	beqz	a0,538e <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    532e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5330:	4798                	lw	a4,8(a5)
    5332:	02977263          	bgeu	a4,s1,5356 <malloc+0xb6>
    if(p == freep)
    5336:	00093703          	ld	a4,0(s2)
    533a:	853e                	mv	a0,a5
    533c:	fef719e3          	bne	a4,a5,532e <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5340:	8552                	mv	a0,s4
    5342:	9ffff0ef          	jal	4d40 <sbrk>
  if(p == SBRK_ERROR)
    5346:	fd551ce3          	bne	a0,s5,531e <malloc+0x7e>
        return 0;
    534a:	4501                	li	a0,0
    534c:	7902                	ld	s2,32(sp)
    534e:	6a42                	ld	s4,16(sp)
    5350:	6aa2                	ld	s5,8(sp)
    5352:	6b02                	ld	s6,0(sp)
    5354:	a03d                	j	5382 <malloc+0xe2>
    5356:	7902                	ld	s2,32(sp)
    5358:	6a42                	ld	s4,16(sp)
    535a:	6aa2                	ld	s5,8(sp)
    535c:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    535e:	fae48de3          	beq	s1,a4,5318 <malloc+0x78>
        p->s.size -= nunits;
    5362:	4137073b          	subw	a4,a4,s3
    5366:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5368:	02071693          	slli	a3,a4,0x20
    536c:	01c6d713          	srli	a4,a3,0x1c
    5370:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5372:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5376:	00003717          	auipc	a4,0x3
    537a:	10a73d23          	sd	a0,282(a4) # 8490 <freep>
      return (void*)(p + 1);
    537e:	01078513          	addi	a0,a5,16
  }
}
    5382:	70e2                	ld	ra,56(sp)
    5384:	7442                	ld	s0,48(sp)
    5386:	74a2                	ld	s1,40(sp)
    5388:	69e2                	ld	s3,24(sp)
    538a:	6121                	addi	sp,sp,64
    538c:	8082                	ret
    538e:	7902                	ld	s2,32(sp)
    5390:	6a42                	ld	s4,16(sp)
    5392:	6aa2                	ld	s5,8(sp)
    5394:	6b02                	ld	s6,0(sp)
    5396:	b7f5                	j	5382 <malloc+0xe2>
