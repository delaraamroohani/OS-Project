...
print_tree_recursive(struct proc_tree *tree, int index, char *prefix, int is_last)
{
  ...
  32:	ae250513          	addi	a0,a0,-1310 # b10 <malloc+0x112>
  ...
  4c:	ad050513          	addi	a0,a0,-1328 # b18 <malloc+0x11a>
  ...
  64:	ac850513          	addi	a0,a0,-1336 # b28 <malloc+0x12a>
  ...
  7e:	a9e50513          	addi	a0,a0,-1378 # b18 <malloc+0x11a>
 ...
 1dc:	94050513          	addi	a0,a0,-1728 # b18 <malloc+0x11a>
...
main(int argc, char *argv[])
{
 ...
 25a:	8da50513          	addi	a0,a0,-1830 # b30 <malloc+0x132>
 ...
 26e:	89e60613          	addi	a2,a2,-1890 # b08 <malloc+0x10a>
 272:	4581                	li	a1,0
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 5fe:	5a650513          	addi	a0,a0,1446 # ba0 <digits>
 602:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 894:	310b8b93          	addi	s7,s7,784 # ba0 <digits>
 ...
 8f6:	2a690913          	addi	s2,s2,678 # b98 <malloc+0x19a>
        for(; *s; s++)
