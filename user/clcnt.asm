...
main(int argc, char *argv[])
{
  ...
  12:	8a250513          	addi	a0,a0,-1886 # 8b0 <malloc+0xfa>
  16:	6ec000ef          	jal	702 <printf>
  getpid();
  ...
  28:	8a450513          	addi	a0,a0,-1884 # 8c8 <malloc+0x112>
  2c:	6d6000ef          	jal	702 <printf>
  exit(0);
  30:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 64c:	2b0b8b93          	addi	s7,s7,688 # 8f8 <digits>
 ...
 6ae:	24690913          	addi	s2,s2,582 # 8f0 <malloc+0x13a>
        for(; *s; s++)
