...
main(int argc, char *argv[])
{
  ...
  12:	8b250513          	addi	a0,a0,-1870 # 8c0 <malloc+0xfa>
  16:	6fc000ef          	jal	712 <printf>
  getpid();
  ...
  28:	8b450513          	addi	a0,a0,-1868 # 8d8 <malloc+0x112>
  2c:	6e6000ef          	jal	712 <printf>
  exit(0);
  30:	4501                	li	a0,0
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3c6:	54650513          	addi	a0,a0,1350 # 908 <digits>
 3ca:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 65c:	2b0b8b93          	addi	s7,s7,688 # 908 <digits>
 ...
 6be:	24690913          	addi	s2,s2,582 # 900 <malloc+0x13a>
        for(; *s; s++)
