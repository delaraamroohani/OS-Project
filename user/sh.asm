...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	24e58593          	addi	a1,a1,590 # 1260 <malloc+0x106>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	21c58593          	addi	a1,a1,540 # 1270 <malloc+0x116>
      5c:	4509                	li	a0,2
      5e:	01e010ef          	jal	107c <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	1f650513          	addi	a0,a0,502 # 1278 <malloc+0x11e>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	2ce70713          	addi	a4,a4,718 # 1378 <malloc+0x21e>
    ...
    panic("runcmd");
      ...
      c6:	1be50513          	addi	a0,a0,446 # 1280 <malloc+0x126>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	1ac58593          	addi	a1,a1,428 # 1288 <malloc+0x12e>
      e4:	4509                	li	a0,2
      e6:	797000ef          	jal	107c <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     114:	18858593          	addi	a1,a1,392 # 1298 <malloc+0x13e>
     118:	4509                	li	a0,2
     11a:	763000ef          	jal	107c <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     176:	13650513          	addi	a0,a0,310 # 12a8 <malloc+0x14e>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	e04a8a93          	addi	s5,s5,-508 # 12d0 <malloc+0x176>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	dd250513          	addi	a0,a0,-558 # 12b0 <malloc+0x156>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	d3e60613          	addi	a2,a2,-706 # 12d8 <malloc+0x17e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	d2eb0b13          	addi	s6,s6,-722 # 12f8 <malloc+0x19e>
  ...
  return ret;
     ...
     5f8:	cec50513          	addi	a0,a0,-788 # 12e0 <malloc+0x186>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	ca250513          	addi	a0,a0,-862 # 12e8 <malloc+0x18e>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	c7c60613          	addi	a2,a2,-900 # 1300 <malloc+0x1a6>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	c28a0a13          	addi	s4,s4,-984 # 1308 <malloc+0x1ae>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	c0660613          	addi	a2,a2,-1018 # 1310 <malloc+0x1b6>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	b7860613          	addi	a2,a2,-1160 # 12d8 <malloc+0x17e>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	ba460613          	addi	a2,a2,-1116 # 1328 <malloc+0x1ce>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	b5e50513          	addi	a0,a0,-1186 # 1318 <malloc+0x1be>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	b6a50513          	addi	a0,a0,-1174 # 1330 <malloc+0x1d6>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	ba270713          	addi	a4,a4,-1118 # 1390 <malloc+0x236>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	9ee60613          	addi	a2,a2,-1554 # 1268 <malloc+0x10e>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	aa058593          	addi	a1,a1,-1376 # 1348 <malloc+0x1ee>
     8b0:	4509                	li	a0,2
     8b2:	7ca000ef          	jal	107c <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	a2a50513          	addi	a0,a0,-1494 # 12e0 <malloc+0x186>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8da:	a8248493          	addi	s1,s1,-1406 # 1358 <malloc+0x1fe>
     8de:	4589                	li	a1,2
     8e0:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     97e:	9e658593          	addi	a1,a1,-1562 # 1360 <malloc+0x206>
     982:	4509                	li	a0,2
     984:	6f8000ef          	jal	107c <fprintf>
...
0000000000000cf6 <set_pid_namespace>:
...
0000000000000cfe <get_pid_namespace>:
...
putc(int fd, char c)
{
     ...
     d24:	1000                	addi	s0,sp,32
     d26:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     d2a:	4605                	li	a2,1
     d2c:	fef40593          	addi	a1,s0,-17
     d30:	f1fff0ef          	jal	c4e <write>
}
     d34:	60e2                	ld	ra,24(sp)
     d36:	6442                	ld	s0,16(sp)
     d38:	6105                	addi	sp,sp,32
     d3a:	8082                	ret

0000000000000d3c <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
     d3c:	715d                	addi	sp,sp,-80
     d3e:	e486                	sd	ra,72(sp)
     d40:	e0a2                	sd	s0,64(sp)
     d42:	f84a                	sd	s2,48(sp)
     d44:	0880                	addi	s0,sp,80
     d46:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
     d48:	c299                	beqz	a3,d4e <printint+0x12>
     d4a:	0805c363          	bltz	a1,dd0 <printint+0x94>
  neg = 0;
     d4e:	4881                	li	a7,0
     d50:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     d56:	00000517          	auipc	a0,0x0
     d5a:	65250513          	addi	a0,a0,1618 # 13a8 <digits>
     d5e:	883e                	mv	a6,a5
     d60:	2785                	addiw	a5,a5,1
     d62:	02c5f733          	remu	a4,a1,a2
     d66:	972a                	add	a4,a4,a0
     d68:	00074703          	lbu	a4,0(a4)
     d6c:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     d70:	872e                	mv	a4,a1
     d72:	02c5d5b3          	divu	a1,a1,a2
     d76:	0685                	addi	a3,a3,1
     d78:	fec773e3          	bgeu	a4,a2,d5e <printint+0x22>
  if(neg)
     d7c:	00088b63          	beqz	a7,d92 <printint+0x56>
    buf[i++] = '-';
     d80:	fd078793          	addi	a5,a5,-48
     d84:	97a2                	add	a5,a5,s0
     d86:	02d00713          	li	a4,45
     d8a:	fee78423          	sb	a4,-24(a5)
     d8e:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     d92:	02f05a63          	blez	a5,dc6 <printint+0x8a>
     d96:	fc26                	sd	s1,56(sp)
     d98:	f44e                	sd	s3,40(sp)
     d9a:	fb840713          	addi	a4,s0,-72
     d9e:	00f704b3          	add	s1,a4,a5
     da2:	fff70993          	addi	s3,a4,-1
     da6:	99be                	add	s3,s3,a5
     da8:	37fd                	addiw	a5,a5,-1
     daa:	1782                	slli	a5,a5,0x20
     dac:	9381                	srli	a5,a5,0x20
     dae:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     db2:	fff4c583          	lbu	a1,-1(s1)
     db6:	854a                	mv	a0,s2
     db8:	f67ff0ef          	jal	d1e <putc>
  while(--i >= 0)
     dbc:	14fd                	addi	s1,s1,-1
     dbe:	ff349ae3          	bne	s1,s3,db2 <printint+0x76>
     dc2:	74e2                	ld	s1,56(sp)
     dc4:	79a2                	ld	s3,40(sp)
}
     dc6:	60a6                	ld	ra,72(sp)
     dc8:	6406                	ld	s0,64(sp)
     dca:	7942                	ld	s2,48(sp)
     dcc:	6161                	addi	sp,sp,80
     dce:	8082                	ret
    x = -xx;
     dd0:	40b005b3          	neg	a1,a1
    neg = 1;
     dd4:	4885                	li	a7,1
    x = -xx;
     dd6:	bfad                	j	d50 <printint+0x14>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     de2:	0005c903          	lbu	s2,0(a1)
     de6:	28090663          	beqz	s2,1072 <vprintf+0x29a>
     dea:	e4a6                	sd	s1,72(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     e12:	a005                	j	e32 <vprintf+0x5a>
        putc(fd, c0);
     e14:	85ca                	mv	a1,s2
     e16:	855a                	mv	a0,s6
     e18:	f07ff0ef          	jal	d1e <putc>
     e1c:	a019                	j	e22 <vprintf+0x4a>
    } else if(state == '%'){
     e1e:	03598263          	beq	s3,s5,e42 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
     e22:	2485                	addiw	s1,s1,1
     e24:	8726                	mv	a4,s1
     e26:	009a07b3          	add	a5,s4,s1
     e2a:	0007c903          	lbu	s2,0(a5)
     e2e:	22090a63          	beqz	s2,1062 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
     e32:	0009079b          	sext.w	a5,s2
    if(state == 0){
     e36:	fe0994e3          	bnez	s3,e1e <vprintf+0x46>
      if(c0 == '%'){
     e3a:	fd579de3          	bne	a5,s5,e14 <vprintf+0x3c>
        state = '%';
     e3e:	89be                	mv	s3,a5
     e40:	b7cd                	j	e22 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     e42:	00ea06b3          	add	a3,s4,a4
     e46:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
     e4a:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     e4c:	c681                	beqz	a3,e54 <vprintf+0x7c>
     e4e:	9752                	add	a4,a4,s4
     e50:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e54:	05878363          	beq	a5,s8,e9a <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     e58:	05978d63          	beq	a5,s9,eb2 <vprintf+0xda>
     ...
     e5c:	07500713          	li	a4,117
     e60:	0ee78763          	beq	a5,a4,f4e <vprintf+0x176>
     ...
     e64:	07800713          	li	a4,120
     e68:	12e78963          	beq	a5,a4,f9a <vprintf+0x1c2>
     ...
     e6c:	07000713          	li	a4,112
     e70:	14e78e63          	beq	a5,a4,fcc <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     e74:	06300713          	li	a4,99
     e78:	18e78e63          	beq	a5,a4,1014 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     e7c:	07300713          	li	a4,115
     e80:	1ae78463          	beq	a5,a4,1028 <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     e84:	02500713          	li	a4,37
     e88:	04e79563          	bne	a5,a4,ed2 <vprintf+0xfa>
        putc(fd, '%');
     e8c:	02500593          	li	a1,37
     e90:	855a                	mv	a0,s6
     e92:	e8dff0ef          	jal	d1e <putc>
     ...
     ed6:	855a                	mv	a0,s6
     ed8:	e47ff0ef          	jal	d1e <putc>
        putc(fd, c0);
     edc:	85ca                	mv	a1,s2
     ede:	855a                	mv	a0,s6
     ee0:	e3fff0ef          	jal	d1e <putc>
      state = 0;
     ee4:	4981                	li	s3,0
     ...
     f40:	855a                	mv	a0,s6
     f42:	dfbff0ef          	jal	d3c <printint>
        i += 2;
     f46:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
     f48:	8bca                	mv	s7,s2
      state = 0;
     f4a:	4981                	li	s3,0
  ...
  putc(fd, '0');
     ...
     fda:	855a                	mv	a0,s6
     fdc:	d43ff0ef          	jal	d1e <putc>
  putc(fd, 'x');
     fe0:	07800593          	li	a1,120
     fe4:	855a                	mv	a0,s6
     fe6:	d39ff0ef          	jal	d1e <putc>
     fea:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fec:	00000b97          	auipc	s7,0x0
     ff0:	3bcb8b93          	addi	s7,s7,956 # 13a8 <digits>
     ff4:	03c9d793          	srli	a5,s3,0x3c
     ff8:	97de                	add	a5,a5,s7
     ffa:	0007c583          	lbu	a1,0(a5)
     ffe:	855a                	mv	a0,s6
    1000:	d1fff0ef          	jal	d1e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1004:	0992                	slli	s3,s3,0x4
    1006:	397d                	addiw	s2,s2,-1
    1008:	fe0916e3          	bnez	s2,ff4 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    100c:	8bea                	mv	s7,s10
      state = 0;
    100e:	4981                	li	s3,0
    1010:	6d02                	ld	s10,0(sp)
    1012:	bd01                	j	e22 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    1014:	008b8913          	addi	s2,s7,8
    1018:	000bc583          	lbu	a1,0(s7)
    101c:	855a                	mv	a0,s6
    101e:	d01ff0ef          	jal	d1e <putc>
    1022:	8bca                	mv	s7,s2
      state = 0;
    1024:	4981                	li	s3,0
    1026:	bbf5                	j	e22 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    1028:	008b8993          	addi	s3,s7,8
    102c:	000bb903          	ld	s2,0(s7)
    1030:	00090f63          	beqz	s2,104e <vprintf+0x276>
        for(; *s; s++)
    1034:	00094583          	lbu	a1,0(s2)
    1038:	c195                	beqz	a1,105c <vprintf+0x284>
          putc(fd, *s);
    103a:	855a                	mv	a0,s6
    103c:	ce3ff0ef          	jal	d1e <putc>
        for(; *s; s++)
    1040:	0905                	addi	s2,s2,1
    1042:	00094583          	lbu	a1,0(s2)
    1046:	f9f5                	bnez	a1,103a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    1048:	8bce                	mv	s7,s3
      state = 0;
    104a:	4981                	li	s3,0
    104c:	bbd9                	j	e22 <vprintf+0x4a>
          s = "(null)";
    104e:	00000917          	auipc	s2,0x0
    1052:	32290913          	addi	s2,s2,802 # 1370 <malloc+0x216>
        for(; *s; s++)
    1056:	02800593          	li	a1,40
    105a:	b7c5                	j	103a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    105c:	8bce                	mv	s7,s3
      state = 0;
    105e:	4981                	li	s3,0
    1060:	b3c9                	j	e22 <vprintf+0x4a>
    1062:	64a6                	ld	s1,72(sp)
    1064:	79e2                	ld	s3,56(sp)
    1066:	7a42                	ld	s4,48(sp)
    1068:	7aa2                	ld	s5,40(sp)
    106a:	7b02                	ld	s6,32(sp)
    106c:	6be2                	ld	s7,24(sp)
    106e:	6c42                	ld	s8,16(sp)
    1070:	6ca2                	ld	s9,8(sp)
    }
  }
}
    1072:	60e6                	ld	ra,88(sp)
    1074:	6446                	ld	s0,80(sp)
    1076:	6906                	ld	s2,64(sp)
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    1098:	8622                	mv	a2,s0
    109a:	d3fff0ef          	jal	dd8 <vprintf>
}
    109e:	60e2                	ld	ra,24(sp)
    10a0:	6442                	ld	s0,16(sp)
    10a2:	6161                	addi	sp,sp,80
    10a4:	8082                	ret

00000000000010a6 <printf>:

void
printf(const char *fmt, ...)
{
    10a6:	711d                	addi	sp,sp,-96
    10a8:	ec06                	sd	ra,24(sp)
    10aa:	e822                	sd	s0,16(sp)
    10ac:	1000                	addi	s0,sp,32
    10ae:	e40c                	sd	a1,8(s0)
    10b0:	e810                	sd	a2,16(s0)
    10b2:	ec14                	sd	a3,24(s0)
    10b4:	f018                	sd	a4,32(s0)
    10b6:	f41c                	sd	a5,40(s0)
    10b8:	03043823          	sd	a6,48(s0)
    10bc:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    10c0:	00840613          	addi	a2,s0,8
    10c4:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    10c8:	85aa                	mv	a1,a0
    10ca:	4505                	li	a0,1
    10cc:	d0dff0ef          	jal	dd8 <vprintf>
}
    10d0:	60e2                	ld	ra,24(sp)
    10d2:	6442                	ld	s0,16(sp)
    10d4:	6125                	addi	sp,sp,96
    10d6:	8082                	ret

00000000000010d8 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    10de:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10e2:	00001797          	auipc	a5,0x1
    10e6:	f2e7b783          	ld	a5,-210(a5) # 2010 <freep>
    10ea:	a02d                	j	1114 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    10ec:	4618                	lw	a4,8(a2)
    10ee:	9f2d                	addw	a4,a4,a1
    10f0:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    10f4:	6398                	ld	a4,0(a5)
    10f6:	6310                	ld	a2,0(a4)
    10f8:	a83d                	j	1136 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    10fa:	ff852703          	lw	a4,-8(a0)
    10fe:	9f31                	addw	a4,a4,a2
    1100:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    1102:	ff053683          	ld	a3,-16(a0)
    1106:	a091                	j	114a <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1108:	6398                	ld	a4,0(a5)
    110a:	00e7e463          	bltu	a5,a4,1112 <free+0x3a>
    110e:	00e6ea63          	bltu	a3,a4,1122 <free+0x4a>
{
    1112:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1114:	fed7fae3          	bgeu	a5,a3,1108 <free+0x30>
    1118:	6398                	ld	a4,0(a5)
    111a:	00e6e463          	bltu	a3,a4,1122 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    111e:	fee7eae3          	bltu	a5,a4,1112 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    1122:	ff852583          	lw	a1,-8(a0)
    1126:	6390                	ld	a2,0(a5)
    1128:	02059813          	slli	a6,a1,0x20
    112c:	01c85713          	srli	a4,a6,0x1c
    1130:	9736                	add	a4,a4,a3
    1132:	fae60de3          	beq	a2,a4,10ec <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    1136:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    113a:	4790                	lw	a2,8(a5)
    113c:	02061593          	slli	a1,a2,0x20
    1140:	01c5d713          	srli	a4,a1,0x1c
    1144:	973e                	add	a4,a4,a5
    1146:	fae68ae3          	beq	a3,a4,10fa <free+0x22>
    p->s.ptr = bp->s.ptr;
    114a:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    114c:	00001717          	auipc	a4,0x1
    1150:	ecf73223          	sd	a5,-316(a4) # 2010 <freep>
}
    1154:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1166:	02051493          	slli	s1,a0,0x20
    116a:	9081                	srli	s1,s1,0x20
    116c:	04bd                	addi	s1,s1,15
    116e:	8091                	srli	s1,s1,0x4
    1170:	0014899b          	addiw	s3,s1,1
    1174:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    1176:	00001517          	auipc	a0,0x1
    117a:	e9a53503          	ld	a0,-358(a0) # 2010 <freep>
    117e:	c915                	beqz	a0,11b2 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1184:	08977a63          	bgeu	a4,s1,1218 <malloc+0xbe>
  ...
  if(nu < 4096)
    1190:	8a4e                	mv	s4,s3
    1192:	0009871b          	sext.w	a4,s3
    1196:	6685                	lui	a3,0x1
    1198:	00d77363          	bgeu	a4,a3,119e <malloc+0x44>
    119c:	6a05                	lui	s4,0x1
    119e:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    11a2:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    11a6:	00001917          	auipc	s2,0x1
    11aa:	e6a90913          	addi	s2,s2,-406 # 2010 <freep>
  if(p == SBRK_ERROR)
    11ae:	5afd                	li	s5,-1
    11b0:	a081                	j	11f0 <malloc+0x96>
    11b2:	f04a                	sd	s2,32(sp)
    11b4:	e852                	sd	s4,16(sp)
    11b6:	e456                	sd	s5,8(sp)
    11b8:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    11ba:	00001797          	auipc	a5,0x1
    11be:	ece78793          	addi	a5,a5,-306 # 2088 <base>
    11c2:	00001717          	auipc	a4,0x1
    11c6:	e4f73723          	sd	a5,-434(a4) # 2010 <freep>
    11ca:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    11cc:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    11d0:	b7c1                	j	1190 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    11d2:	6398                	ld	a4,0(a5)
    11d4:	e118                	sd	a4,0(a0)
    11d6:	a8a9                	j	1230 <malloc+0xd6>
  hp->s.size = nu;
    11d8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    11dc:	0541                	addi	a0,a0,16
    11de:	efbff0ef          	jal	10d8 <free>
  return freep;
    11e2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    11e6:	c12d                	beqz	a0,1248 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11e8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    11ea:	4798                	lw	a4,8(a5)
    11ec:	02977263          	bgeu	a4,s1,1210 <malloc+0xb6>
    if(p == freep)
    11f0:	00093703          	ld	a4,0(s2)
    11f4:	853e                	mv	a0,a5
    11f6:	fef719e3          	bne	a4,a5,11e8 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    11fa:	8552                	mv	a0,s4
    11fc:	9ffff0ef          	jal	bfa <sbrk>
  if(p == SBRK_ERROR)
    1200:	fd551ce3          	bne	a0,s5,11d8 <malloc+0x7e>
        return 0;
    1204:	4501                	li	a0,0
